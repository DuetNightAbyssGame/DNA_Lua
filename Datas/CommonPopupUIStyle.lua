...
return ReadOnly("CommonPopupUIStyle", {
	...
	Activity_TotalRecharge_DetailHistoryContent = {
		BigSize = true,
		ShowContent = {
			[1] = "WBP_Activity_TotalRecharge_DetailHistoryContent",
		},
	...
	Chat_ChannelContent = {
		ShowContent = {
			[1] = "Chat_ChannelContent",
		},
		ShowLeftButton = 1,
		ShowRightButton = 2,
		StyleId = "Chat_ChannelContent",
		UseTabTitle = true,
	},
	...
	Dispatch_RewardPackDetail_Dialog = {
		ShowContent = {
			[1] = "RewardPack_Detail",
		},
		StyleId = "Dispatch_RewardPackDetail_Dialog",
	},
	Dispatch_RewardPack_Dialog = {
		ShowContent = {
			[1] = "Dispatch_RewardPack",
		},
		StyleId = "Dispatch_RewardPack_Dialog",
	},
	...
	Gift_Condition = {
		ShowContent = {
			[1] = "WBP_Gift_Condition",
		},
		StyleId = "Gift_Condition",
	},
	Gift_NotEnough = {
		ShowContent = {
			[1] = "Gift_NotEnough",
		...
		ShowLeftButton = 1,
		ShowRightButton = 1,
		StyleId = "Gift_NotEnough",
	},
	Gift_ShopTarget = {
		ShowContent = {
			[1] = "WBP_Gift_ShopTarget",
		},
		StyleId = "Gift_ShopTarget",
	},
	Gift_ShopTarget_ChooseFriendContent = {
		ShowContent = {
			[1] = "WBP_Gift_ShopTarget_ChooseFriendContent",
		},
	...
	LimitedPrizePool_OptionalAvatar = {
		BigSize = true,
		ShowContent = T.RT_9,
		ShowLeftButton = 1,
		ShowRightButton = 2,
		StyleId = "LimitedPrizePool_OptionalAvatar",
	},
	LongTextDefault = {
		ShowContent = T.RT_10,
		ShowLeftButton = 1,
	...
	MobileLayoutplayManage = {
		ShowContent = {
			[1] = "WBP_BattleSolutionPart",
		},
		StyleId = "MobileLayoutplayManage",
	},
	...
	Pet_Skill_Preview = {
		ShowContent = {
			[1] = "WBP_Pet_skill_Preview",
		},
		StyleId = "Pet_Skill_Preview",
		UseTabTitle = true,
	},
	...
	Reward_RandomBox_Open = {
		ShowContent = T.RT_11,
		ShowLeftButton = 1,
		ShowRightButton = 1,
		StyleId = "Reward_RandomBox_Open",
	},
	Reward_RandomBox_Preview = {
		ShowContent = T.RT_11,
		StyleId = "Reward_RandomBox_Preview",
	},
	SettingChangeKey = {
		ShowContent = T.RT_12,
		ShowLeftButton = 1,
	...
	Skin_Upgrade_Confirm = {
		ShowContent = T.RT_4,
		ShowLeftButton = 1,
		ShowRightButton = 1,
		StyleId = "Skin_Upgrade_Confirm",
	},
	TestStyle = {
		ShowContent = T.RT_2,
		ShowLeftButton = 1,
	...
	WBP_Forging_ExchangePart = {
		ShowContent = {
			[1] = "WBP_Forging_ExchangePart_Content",
		},
		ShowLeftButton = 1,
		ShowRightButton = 1,
		ShowTip = T.RT_5,
