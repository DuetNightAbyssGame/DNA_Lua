...
return ReadOnly("SystemUI", {
	...
	Abyss_Review = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Abyss/Widget/Dialog_Review/WBP_Abyss_Review.WBP_Abyss_Review'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Abyss/Widget/Dialog_Review/WBP_Abyss_Review.WBP_Abyss_Review'",
		UIName = "Abyss_Review",
		ZOrder = 57,
	},
	AchievementPanel = {
	...
	ActivityCamreaGame = {
		ConfigName = "StackAndUIMode",
		IsHideBattleUnit = 1,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/CameraGame/WBP_Activity_CameraGame_M.WBP_Activity_CameraGame_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/CameraGame/WBP_Activity_CameraGame_P.WBP_Activity_CameraGame_P'",
		Popup = true,
	...
	ActivityEastTask02 = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/East/Season02/WBP_Activity_East_Sason02_Task_M.WBP_Activity_East_Sason02_Task_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/East/Season02/WBP_Activity_East_Sason02_Task_P.WBP_Activity_East_Sason02_Task_P'",
		UIName = "ActivityEastTask02",
		ZOrder = 56,
	},
	ActivityFeinaEventLevelSelect = {
		ConfigName = "StackAndUIMode",
	...
	ActivityFoolArchive = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/Fool/Archive/WBP_Activity_Fool_Archive.WBP_Activity_Fool_Archive'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/Fool/Archive/WBP_Activity_Fool_Archive.WBP_Activity_Fool_Archive'",
		UIName = "ActivityFoolArchive",
	},
	ActivityFortTask = {
		ConfigName = "StackAndUIMode",
		IsHideBattleUnit = 1,
	...
	ActivityReturnMain = {
		ConfigName = "StackAndUIMode",
		IsBanAccess = true,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/Return/WBP_Activity_Return_Main_M.WBP_Activity_Return_Main_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/Return/WBP_Activity_Return_Main_P.WBP_Activity_Return_Main_P'",
		UIName = "ActivityReturnMain",
		ZOrder = 56,
	},
	ActivityRewardNoraml = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/Reward/Base/Normal/WBP_Activity_RewardContent_Normal_M.WBP_Activity_RewardContent_Normal_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/Reward/Base/Normal/WBP_Activity_RewardContent_Normal_P.WBP_Activity_RewardContent_Normal_P'",
		UIName = "ActivityRewardNoraml",
		ZOrder = 59,
	},
	ActivityRewardPacking = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/Reward/Base/PackingDesign/WBP_Activity_RewardContent_PackingDesign_M.WBP_Activity_RewardContent_PackingDesign_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/Reward/Base/PackingDesign/WBP_Activity_RewardContent_PackingDesign_P.WBP_Activity_RewardContent_PackingDesign_P'",
		UIName = "ActivityRewardPacking",
		ZOrder = 59,
	},
	ActivityShop = {
		ConfigName = "OnlyUIMode",
	...
	ActivitySoloTreasureMain = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/SoloTreasure/WBP_Activity_SoloTreasure_Main_M.WBP_Activity_SoloTreasure_Main_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/SoloTreasure/WBP_Activity_SoloTreasure_Main_P.WBP_Activity_SoloTreasure_Main_P'",
		Popup = true,
		TabCoin = {
			6000004,
			6000005,
		},
		UIName = "ActivitySoloTreasureMain",
		ZOrder = 56,
	},
	ActivityTempleSoloTask = {
		ConfigName = "StackAndUIMode",
	...
	AnnouncementMain = {
		...
		IsHideDrop = true,
		IsStopGame = 1,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Announcement/Mobile/WBP_Announcement_Main_M.WBP_Announcement_Main_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Announcement/PC/WBP_Announcement_Main_P.WBP_Announcement_Main_P'",
		Params = T.RT_2,
		Popup = true,
		Swallow = true,
	...
	AprilFoolDayHUD = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/Fool/WBP_Activity_Fool_BattleMain_M.WBP_Activity_Fool_BattleMain_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/Fool/WBP_Activity_Fool_BattleMain_P.WBP_Activity_Fool_BattleMain_P'",
		Popup = true,
		UIName = "AprilFoolDayHUD",
	},
	AprilFoolDayRandomTrans = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/Fool/Archive/WBP_Activity_Fool_Archive_DrawAni.WBP_Activity_Fool_Archive_DrawAni'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/Fool/Archive/WBP_Activity_Fool_Archive_DrawAni.WBP_Activity_Fool_Archive_DrawAni'",
		Popup = true,
		UIName = "AprilFoolDayRandomTrans",
	},
	AprilFoolDayReward = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/Fool/WBP_Activity_FoolRewardContent_PackingDesign_M.WBP_Activity_FoolRewardContent_PackingDesign_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/Fool/WBP_Activity_FoolRewardContent_PackingDesign_P.WBP_Activity_FoolRewardContent_PackingDesign_P'",
		UIName = "AprilFoolDayReward",
	},
	AprilFoolDayTransList = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/Fool/Battle/WBP_Activity_Fool_BattleChange.WBP_Activity_Fool_BattleChange'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/Fool/Battle/WBP_Activity_Fool_BattleChange.WBP_Activity_Fool_BattleChange'",
		Popup = true,
		UIName = "AprilFoolDayTransList",
	},
	AprilFoolsDayMain = {
		ConfigName = "StackAndUIMode",
		IsHideBattleUnit = 11,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/Fool/WBP_Activity_Fool_Main_M.WBP_Activity_Fool_Main_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/Fool/WBP_Activity_Fool_Main_P.WBP_Activity_Fool_Main_P'",
		Popup = true,
		UIName = "AprilFoolsDayMain",
	},
	AprilFoolsDayPost = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/Fool/Post/WBP_Activity_Fool_Post.WBP_Activity_Fool_Post'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/Fool/Post/WBP_Activity_Fool_Post.WBP_Activity_Fool_Post'",
		UIName = "AprilFoolsDayPost",
		ZOrder = 56,
	},
	ArchiveBookDetail = {
		ConfigName = "OnlyUIMode",
	...
	ArmorySkinVideo_Sp = {
		...
		IsStopGame = 2,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Armory/Widget/Appearance/WBP_Armory_SkinVideo.WBP_Armory_SkinVideo'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Armory/Widget/Appearance/WBP_Armory_SkinVideo_Sp.WBP_Armory_SkinVideo_Sp'",
		Popup = true,
		SpecialUINameList = T.RT_4,
		StateTag = 1,
		System = "Armory",
		UIName = "ArmorySkinVideo_Sp",
		ZOrder = 55,
	},
	ArmoryTraceDetails = {
		ConfigName = "StackAndUIMode",
	...
	AutoChessBuffDetail = {
		ConfigName = "OnlyUIMode",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/AutoChess/Buff/WBP_Activity_AutoChess_BuffDetail.WBP_Activity_AutoChess_BuffDetail'",
		UIName = "AutoChessBuffDetail",
		ZOrder = 57,
	},
	AutoChessChooseEquip = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/AutoChess/WBP_Activity_AutoChess_ReplaceEquipment.WBP_Activity_AutoChess_ReplaceEquipment'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/AutoChess/WBP_Activity_AutoChess_ReplaceEquipment.WBP_Activity_AutoChess_ReplaceEquipment'",
		UIName = "AutoChessChooseEquip",
		ZOrder = 57,
	},
	AutoChessDeputeMonsterInfoUI = {
		ConfigName = "OnlyUIMode",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/AutoChess/WBP_Activity_AutoChess_DeputeMonsterInfo.WBP_Activity_AutoChess_DeputeMonsterInfo'",
		UIName = "AutoChessDeputeMonsterInfoUI",
		ZOrder = 57,
	},
	AutoChessMain = {
		ConfigName = "StackAndUIMode",
		IsStopGame = 1,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/AutoChess/WBP_Activity_AutoChess_Main_M.WBP_Activity_AutoChess_Main_M'",
	...
	AutoChessPresetPage = {
		...
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/AutoChess/WBP_Activity_AutoChess_PresetPage_P.WBP_Activity_AutoChess_PresetPage_P'",
		UIName = "AutoChessPresetPage",
		ZOrder = 55,
	},
	AutoChessReward = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/AutoChess/Task/WBP_Activity_AutoChess_RewardContent_Normal_M.WBP_Activity_AutoChess_RewardContent_Normal_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/AutoChess/Task/WBP_Activity_AutoChess_RewardContent_Normal_P.WBP_Activity_AutoChess_RewardContent_Normal_P'",
		UIName = "AutoChessReward",
		ZOrder = 59,
	},
	AutoChessSettlement = {
		ConfigName = "StackAndUIMode",
		...
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/AutoChess/WBP_Activity_AutoChess_Settlement_P.WBP_Activity_AutoChess_Settlement_P'",
	...
	BagGameMain = {
		ConfigName = "OnlyUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/BagGame/WBP_Activity_BagGameMain_M.WBP_Activity_BagGameMain_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/BagGame/WBP_Activity_BagGameMain_P.WBP_Activity_BagGameMain_P'",
		UIName = "BagGameMain",
		ZOrder = 56,
	},
	BagGamePlay = {
		ConfigName = "OnlyUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/BagGame/WBP_Activity_BagGame_Play.WBP_Activity_BagGame_Play'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Widget/BagGame/WBP_Activity_BagGame_Play.WBP_Activity_BagGame_Play'",
		UIName = "BagGamePlay",
		ZOrder = 57,
	},
	BagMain = {
	...
	ChapterUI = {
		IsStopGame = 1,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/ChapterStart/Widget/WBP_Chapter_Transition03.WBP_Chapter_Transition03'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/ChapterStart/Widget/WBP_Chapter_Transition03.WBP_Chapter_Transition03'",
		UIName = "ChapterUI",
		ZOrder = 104,
	},
	...
	CommonNumInput = {
		ConfigName = "UIModeAndForceShow",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Common/Dialog/WBP_Com_Dialog_InputNum.WBP_Com_Dialog_InputNum'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Common/Dialog/WBP_Com_Dialog_InputNum.WBP_Com_Dialog_InputNum'",
		System = "Common",
	...
	CustomHUDSettingTrailUI = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Battle/Mobile/Unit/WBP_SettingCustomOnTrial_M.WBP_SettingCustomOnTrial_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Battle/Mobile/Unit/WBP_SettingCustomOnTrial_M.WBP_SettingCustomOnTrial_M'",
		System = "Battle",
		UIName = "CustomHUDSettingTrailUI",
		ZOrder = -3,
	},
	DayAndNight = {
		CombatconditionIdList = {
	...
	DungeonLevelMapMain = {
		...
		IsStopGame = 2,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Map/Mobile/WBP_Map_Dungeon_M.WBP_Map_Dungeon_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Map/PC/WBP_Map_Dungeon_P.WBP_Map_Dungeon_P'",
		Popup = true,
		UIName = "DungeonLevelMapMain",
		ZOrder = 50,
	},
	...
	FameMain = {
		...
		IsHideBattleUnit = 11,
		IsStopGame = 2,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Fame/Mobile/WBP_Fame_Main_M.WBP_Fame_Main_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Fame/PC/WBP_Fame_Main_P.WBP_Fame_Main_P'",
		Popup = true,
		UIName = "FameMain",
		ZOrder = 56,
	},
	FameReward = {
		...
		IsHideBattleUnit = 1,
		IsStopGame = 2,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Fame/Mobile/WBP_Fame_RewardContent_M.WBP_Fame_RewardContent_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Fame/PC/WBP_Fame_RewardContent_P.WBP_Fame_RewardContent_P'",
		Popup = true,
		UIName = "FameReward",
		ZOrder = 58,
	},
	FameTask = {
		...
		IsHideBattleUnit = 1,
		IsStopGame = 2,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Fame/Mobile/WBP_Fame_Task_M.WBP_Fame_Task_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Fame/PC/WBP_Fame_Task_P.WBP_Fame_Task_P'",
		Popup = true,
		UIName = "FameTask",
		ZOrder = 57,
	},
	...
	GiftGet = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Gift/Widget/WBP_Gift_GetGift.WBP_Gift_GetGift'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Gift/Widget/WBP_Gift_GetGift.WBP_Gift_GetGift'",
		Params = T.RT_2,
		Popup = true,
		UIName = "GiftGet",
		ZOrder = 55,
	...
	GiftShop = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Gift/Mobile/WBP_Gift_Shop_Main_M.WBP_Gift_Shop_Main_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Gift/PC/WBP_Gift_Shop_Main_P.WBP_Gift_Shop_Main_P'",
		Popup = true,
		UIName = "GiftShop",
		ZOrder = 55,
	},
	...
	LeaveSoloTreasureExtractionTips = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_HudTips05.WBP_SoloTreasure_HudTips05'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_HudTips05.WBP_SoloTreasure_HudTips05'",
		UIName = "LeaveSoloTreasureExtractionTips",
	},
	LeaveSoloTreasureRainTips = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_HudTips03.WBP_SoloTreasure_HudTips03'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_HudTips03.WBP_SoloTreasure_HudTips03'",
		UIName = "LeaveSoloTreasureRainTips",
		ZOrder = 20,
	},
	LevelMapMain = {
		ConfigName = "StackAndFullScreen",
	...
	LimitedPrizePoolReward = {
		ConfigName = "OnlyUIMode",
		IsBanAccess = true,
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/Mobile/LimitedPrizePool/WBP_LimitedPrizePool_GetReward_M.WBP_LimitedPrizePool_GetReward_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Activity/PC/LimitedPrizePool/WBP_LimitedPrizePool_GetReward_P.WBP_LimitedPrizePool_GetReward_P'",
		UIName = "LimitedPrizePoolReward",
		ZOrder = 59,
	},
	Loading = {
		UIName = "Loading",
	...
	MountLicense = {
		ConfigName = "StackAndUIMode",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Mounts/Widget/WBP_Mounts_License_Dialog.WBP_Mounts_License_Dialog'",
		UIName = "MountLicense",
	},
	MountLicenseUnlockDialog = {
		ConfigName = "StackAndUIMode",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Mounts/Widget/WBP_Mounts_License_UnlockDialog.WBP_Mounts_License_UnlockDialog'",
		UIName = "MountLicenseUnlockDialog",
	},
	MountsMain = {
		ConfigName = "StackAndUIMode",
		IsHideBattleUnit = 1,
	...
	OptionalPatch = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Download/Widget/WBP_Download_Content.WBP_Download_Content'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Download/Widget/WBP_Download_Content.WBP_Download_Content'",
		UIName = "OptionalPatch",
		ZOrder = 99,
	},
	PayGiftPopup_Purple = {
		ConfigName = "OnlyUIMode",
	...
	PersonalInfoDataRanking = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/PersonalInfo/Mobile/WBP_PersonalInfo_Data_Ranking_M.WBP_PersonalInfo_Data_Ranking_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/PersonalInfo/PC/WBP_PersonalInfo_Data_Ranking_P.WBP_PersonalInfo_Data_Ranking_P'",
		UIName = "PersonalInfoDataRanking",
	},
	PetCapture = {
		ConfigName = "OnlyUIMode",
		IsBanAccess = true,
	...
	ReputationLevelUp = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Battle/Widget/Reputation/WBP_Battle_HUD_ReputationTip.WBP_Battle_HUD_ReputationTip'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Battle/Widget/Reputation/WBP_Battle_HUD_ReputationTip.WBP_Battle_HUD_ReputationTip'",
		UIName = "ReputationLevelUp",
		ZOrder = -9,
	},
	RougeArchiveEvent = {
		ConfigName = "OnlyUIMode",
	...
	SettlementMVP = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Settlement/Mobile/WBP_Settlement_MVP_M.WBP_Settlement_MVP_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Settlement/PC/WBP_Settlement_MVP_P.WBP_Settlement_MVP_P'",
		Popup = true,
		UIName = "SettlementMVP",
	},
	ShopActivity = {
		ConfigName = "StackAndUIMode",
		GlobalGameUITag = "Shop",
	...
	ShopTargetPay = {
		ConfigName = "OnlyUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Gift/Widget/WBP_Gift_ShopTarget_PayContent.WBP_Gift_ShopTarget_PayContent'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Gift/Widget/WBP_Gift_ShopTarget_PayContent.WBP_Gift_ShopTarget_PayContent'",
		System = "Shop",
		UIName = "ShopTargetPay",
		ZOrder = 100,
	},
	ShuiFa = {
	...
	SoloTreasure3Choose1 = {
		ConfigName = "OnlyUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Mobile/WBP_SoloTreasure_Choice_M.WBP_SoloTreasure_Choice_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/PC/WBP_SoloTreasure_Choice_P.WBP_SoloTreasure_Choice_P'",
		Popup = true,
		UIName = "SoloTreasure3Choose1",
		ZOrder = 55,
	},
	SoloTreasureBag = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Mobile/WBP_SoloTreasure_Bag_M.WBP_SoloTreasure_Bag_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/PC/WBP_SoloTreasure_Bag_P.WBP_SoloTreasure_Bag_P'",
		Popup = true,
		UIName = "SoloTreasureBag",
		ZOrder = 55,
	},
	SoloTreasureBuffToast = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/Choice/WBP_SoloTreasure_ChoiceBuffTip.WBP_SoloTreasure_ChoiceBuffTip'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/Choice/WBP_SoloTreasure_ChoiceBuffTip.WBP_SoloTreasure_ChoiceBuffTip'",
		System = "Battle",
		UIName = "SoloTreasureBuffToast",
		ZOrder = 20,
	},
	SoloTreasureCountDownTip = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_CountDown.WBP_SoloTreasure_CountDown'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_CountDown.WBP_SoloTreasure_CountDown'",
		System = "Battle",
		UIName = "SoloTreasureCountDownTip",
		ZOrder = 60,
	},
	SoloTreasureEvacuation = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Mobile/WBP_SoloTreasure_Evacuation_M.WBP_SoloTreasure_Evacuation_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/PC/WBP_SoloTreasure_Evacuation_P.WBP_SoloTreasure_Evacuation_P'",
		Popup = true,
		UIName = "SoloTreasureEvacuation",
		ZOrder = 66,
	},
	SoloTreasureExtractionCountDownTips = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_HudTips04.WBP_SoloTreasure_HudTips04'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_HudTips04.WBP_SoloTreasure_HudTips04'",
		UIName = "SoloTreasureExtractionCountDownTips",
		ZOrder = 20,
	},
	SoloTreasureFinishTip = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/PC/WBP_SoloTreasure_Settlement_Finish_P.WBP_SoloTreasure_Settlement_Finish_P'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/PC/WBP_SoloTreasure_Settlement_Finish_P.WBP_SoloTreasure_Settlement_Finish_P'",
		Popup = true,
		Swallow = true,
		UIName = "SoloTreasureFinishTip",
		ZOrder = 64,
	},
	SoloTreasureHudTips01 = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_HudTips01.WBP_SoloTreasure_HudTips01'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_HudTips01.WBP_SoloTreasure_HudTips01'",
		UIName = "SoloTreasureHudTips01",
		ZOrder = 20,
	},
	SoloTreasureItemSettlement = {
		ConfigName = "StackAndUIMode",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Mobile/WBP_SoloTreasure_Settlement_m.WBP_SoloTreasure_Settlement_M'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/PC/WBP_SoloTreasure_Settlement_P.WBP_SoloTreasure_Settlement_P'",
		Popup = true,
	...
	SoloTreasureReplaceBuff = {
		...
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/PC/WBP_SoloTreasure_Replace_P.WBP_SoloTreasure_Replace_P'",
		Popup = true,
		UIName = "SoloTreasureReplaceBuff",
		ZOrder = 56,
	},
	SoloTreasureTimeTip = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_HudTips02.WBP_SoloTreasure_HudTips02'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/SoloTreasure/Widget/WBP_SoloTreasure_HudTips02.WBP_SoloTreasure_HudTips02'",
		System = "BattleSubsystem",
		UIName = "SoloTreasureTimeTip",
		ZOrder = 60,
	},
	...
	UISkillSuyi = {
		ConfigName = "OnlyForceShow",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Battle/Widget/ExclusiveSkill/WBP_Battle_SuyiSkill.WBP_Battle_SuyiSkill'",
		System = "Battle",
		UIName = "UISkillSuyi",
		ZOrder = -3,
	},
	UISkillSuyi01 = {
		ConfigName = "OnlyForceShow",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Battle/Widget/ExclusiveSkill/WBP_Battle_SuyiSkill_Sp.WBP_Battle_SuyiSkill_Sp'",
		System = "Battle",
	...
	UISkillSuyiUlti = {
		ConfigName = "OnlyForceShow",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Battle/Widget/ExclusiveSkill/WBP_Battle_SuyiUltiSkill.WBP_Battle_SuyiUltiSkill'",
		System = "Battle",
	...
	UISkillSuyiUlti01 = {
		ConfigName = "OnlyForceShow",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Battle/Widget/ExclusiveSkill/WBP_Battle_SuyiUltiSkill_Sp.WBP_Battle_SuyiUltiSkill_Sp'",
		System = "Battle",
	...
	WaterMark = {
		ConfigName = "OnlyForceShow",
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Common/WBP_Com_WaterMark.WBP_Com_WaterMark'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Common/WBP_Com_WaterMark.WBP_Com_WaterMark'",
		UIName = "WaterMark",
		ZOrder = 200,
	},
	WaveStartBP = {
	...
	YanQueProgress = {
		MobileBPPath = "WidgetBlueprint'/Game/UI/WBP/Dungeon/Escort/WBP_Dungeon_EscortMain.WBP_Dungeon_EscortMain'",
		PCBPPath = "WidgetBlueprint'/Game/UI/WBP/Dungeon/Escort/WBP_Dungeon_EscortMain.WBP_Dungeon_EscortMain'",
		UIName = "YanQueProgress",
	},
	ZhiLiuDoorQTE = {
