...
return ReadOnly("BattlePassMain", {
	...
	[100007] = {
		BPRewardTemplateID = 100007,
		BPRewardTyppe = "Skin",
		BattlePassEndTime = LocalTimeProxy(1777928399),
		BattlePassId = 100007,
		BattlePassStartTime = LocalTimeProxy(1775509200),
		BattlePassTitle = "UI_BPTitle_100007",
		LevelExp = 500,
		LevelLimit = 1000,
		LoopFreeRewardId = T.RT_5,
		LoopPaidRewardId = T.RT_6,
		...
		PetClaimLevel = 30,
		PetId = T.RT_1,
		PreviewSkinSeries = "BP_04",
		Rank2GoodsId = "com.hero.dna.Pay_BattlePassRank2",
		Rank2RewardView = 10000768,
		Rank2to3GoodsId = "com.hero.dna.Pay_BattlePassRank2to3",
		Rank3GoodsId = "com.hero.dna.Pay_BattlePassRank3",
		Rank3Reward = 100005,
		Rank3RewardView = 100007,
		RewardMailId = 100401,
		SkyBoxColor = T.RT_4,
		WeeklyMaxExp = 8000,
	},
	[100008] = {
		BPRewardTemplateID = 100008,
		BPRewardTyppe = "Skin",
		BattlePassEndTime = LocalTimeProxy(1780304399),
		BattlePassId = 100008,
		BattlePassStartTime = LocalTimeProxy(1777928400),
		BattlePassTitle = "UI_BPTitle_100008",
		LevelExp = 500,
		LevelLimit = 1000,
		LoopFreeRewardId = T.RT_5,
		LoopPaidRewardId = T.RT_6,
