...
return ReadOnly("ModDungeonMonReward", {
	...
	[5005] = {
		Condition = T.RT_3,
		DungeonDropReward = 135005,
		DungeonList = {
			90169,
		},
		DungeonRewardView = 135005,
		MonRewardId = 5005,
		MonsterUnitId = 9001014,
		Sequence = 1,
	},
	[5006] = {
		Condition = T.RT_3,
		DungeonDropReward = 135006,
		DungeonList = {
			90170,
		},
		DungeonRewardView = 135006,
		MonRewardId = 5006,
		MonsterUnitId = 8003022,
		Sequence = 2,
	},
	[5501] = {
		Condition = T.RT_4,
	...
	[6009] = {
		Condition = T.RT_5,
		DungeonDropReward = 136009,
		DungeonList = {
			91126,
		},
		DungeonRewardView = 136009,
		MonRewardId = 6009,
		MonsterUnitId = 6015021,
		Sequence = 3,
	},
	[6010] = {
		Condition = T.RT_5,
	...
	[6011] = {
		Condition = T.RT_5,
		DungeonDropReward = 136011,
		DungeonList = {
			91128,
		},
		DungeonRewardView = 136011,
		MonRewardId = 6011,
		MonsterUnitId = 6017012,
		Sequence = 1,
	},
	[6012] = {
		Condition = T.RT_5,
		DungeonDropReward = 136012,
		DungeonList = {
			91129,
		},
		DungeonRewardView = 136012,
		MonRewardId = 6012,
		MonsterUnitId = 6016022,
		Sequence = 2,
	},
	[6501] = {
		Condition = T.RT_6,
	...
	[7007] = {
		Condition = T.RT_7,
		DungeonDropReward = 137007,
		DungeonList = {
			91136,
		},
		DungeonRewardView = 137007,
		MonRewardId = 7007,
		MonsterUnitId = 10005011,
		Sequence = 1,
	},
	[8001] = {
		Condition = T.RT_8,
	...
	[8006] = {
		Condition = T.RT_8,
		DungeonDropReward = 138006,
		DungeonList = {
			91132,
		},
		DungeonRewardView = 138006,
		MonRewardId = 8006,
		MonsterUnitId = 6017013,
		Sequence = 20,
	},
	[8007] = {
		Condition = T.RT_8,
		DungeonDropReward = 138007,
		DungeonList = {
			91133,
		},
		DungeonRewardView = 138007,
		MonRewardId = 8007,
		MonsterUnitId = 10005013,
		Sequence = 30,
	},
	[8008] = {
		Condition = T.RT_8,
		DungeonDropReward = 138008,
		DungeonList = {
			91134,
		},
		DungeonRewardView = 138008,
		MonRewardId = 8008,
		MonsterUnitId = 6015018,
		Sequence = 40,
	},
	[8009] = {
		Condition = T.RT_8,
		DungeonDropReward = 138009,
		DungeonList = {
			91135,
		},
		DungeonRewardView = 138009,
		MonRewardId = 8009,
	...
	[8010] = {
		Condition = T.RT_8,
		DungeonDropReward = 138010,
		DungeonList = {
			91148,
		},
		DungeonRewardView = 138010,
		MonRewardId = 8010,
	...
	[8011] = {
		Condition = T.RT_8,
		DungeonDropReward = 138011,
		DungeonList = {
			91149,
		},
		DungeonRewardView = 138011,
		MonRewardId = 8011,
		MonsterUnitId = 6004013,
		Sequence = 20,
	},
	[8012] = {
		Condition = T.RT_8,
		DungeonDropReward = 138012,
		DungeonList = {
			91150,
		},
		DungeonRewardView = 138012,
		MonRewardId = 8012,
		MonsterUnitId = 10005023,
		Sequence = 30,
	},
	[8013] = {
		Condition = T.RT_8,
		DungeonDropReward = 138013,
		DungeonList = {
			91187,
		},
		DungeonRewardView = 138013,
		MonRewardId = 8013,
		MonsterUnitId = 10005019,
		Sequence = 40,
	},
	[11001] = {
		DungeonDropReward = 131001,
