...
function M:StatRecordTimer()
    ...
    StrOutput = StrOutput .. CurrentNiagaraPath .. StrSpace .. EMData.FrameTime .. StrSpace .. EMData.GameThreadTime .. StrSpace .. EMData.RenderThreadTime .. StrSpace
                    .. EMData.GPUFrameTime .. StrLine
