...
function WBP_ImpressionResult_PC:SwitchBindDicePressInput(bBind)
    ...
    if bBind then
        self:ListenForInputAction("TalkClick", EInputEvent.IE_Pressed, false, {self.Key_ResultPlay, self.Key_ResultPlay.OnAutoKeyPressed})
        self:ListenForInputAction("TalkExit", EInputEvent.IE_Pressed, false, {self.Key_ResultPlay, self.Key_ResultPlay.OnSkipKeyPressed})
...
function WBP_ImpressionResult_PC:SwitchBindDiceReleaseInput(bBind)
    ...
    if bBind then
        self:ListenForInputAction("TalkClick", EInputEvent.IE_Released, false, {self.Key_ResultPlay, self.Key_ResultPlay.OnAutoKeyReleased})
        -- self.Btn_Dice:SetVisibility(UE4.ESlateVisibility.Visible)
...
function WBP_ImpressionResult_PC:SwitchBindSkipInput(bBind)
    ...
    if bBind then
        self:ListenForInputAction("TalkSkip", EInputEvent.IE_Pressed, false, {self.Key_ResultPlay, self.Key_ResultPlay.OnSkipKeyPressed})
        self:ListenForInputAction("TalkSkip", EInputEvent.IE_Released, false, {self.Key_ResultPlay, self.Key_ResultPlay.OnSkipKeyReleased})
