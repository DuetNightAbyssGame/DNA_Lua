...
---@type BP_Impression_DimensionResult_C
local BP_Impression_DimensionResult_C = Class("BluePrints.UI.BP_UIState_C")

-- function BP_Impression_DimensionResult_C:Initialize(Initializer)
-- end

-- function BP_Impression_DimensionResult_C:PreConstruct(IsDesignTime)
-- end

-- function BP_Impression_DimensionResult_C:Construct()
-- end

-- function BP_Impression_DimensionResult_C:Tick(MyGeometry, InDeltaTime)
-- end
...
function BP_Impression_DimensionResult_C:Init(bCheckSucceed, ImpressionAreaId, PlusType, PlusValue)
    ...
    self:BindToAnimationFinished(self.In, {self, self.TimeFadeOut})
