...
---@class WBP_Simple_Common : BP_TalkBaseUINew_C
...
function WBP_Simple_Common:PostEnterTalkTask(TalkTask, TaskData, OnPostEnterTalkTaskFinished)
    ...
    -- Todo:迭代掉
    if(TaskData.BlendInTime==-1) then
        self:EnableFilmBack()
    end
...
--- @param OptionTexts table<number,string> 选项数组
--- @param OnOptionItemClicked function<USimpleDialogueButtonItem>
