local TalkState2EventId={
    ...
    [Const.TalkState_DisableMonsterSpawn] = {nil,EventID.TalkEnableMonsterSpawn},
    [Const.TalkState_HiddenGameUI] = {nil,EventID.TalkHiddenGameUI},
}
---@class TalkStateManager_C
local TalkStateManager_C = {}
TalkStateManager_C.New = function()
    ---@type TalkStateManager_C
    local Obj = setmetatable({}, {
        __index = TalkStateManager_C
    })
