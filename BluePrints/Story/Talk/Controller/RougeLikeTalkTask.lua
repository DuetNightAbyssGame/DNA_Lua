...
---@class FRougeLikeTalkTask:TalkTaskBase_C
local FRougeLikeTalkTask = Class({"BluePrints.Story.Talk.Controller.TalkTaskBase"})

---@param TalkTaskData GuideTalkTaskData_C
---@param TaskFinished_Callback table<function,table>
