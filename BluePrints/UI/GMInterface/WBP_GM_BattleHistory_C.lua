...
---@class GM_BattleHistory_C : WBP_GM_BattleHistory_C
...
function GM_BattleHistory_C:InitRecordFilter()
    ...
    for _, Tag in ipairs(self.Tags) do
        ...
        TagObj.Name = Tag
        TagObj.UI = self
        TagObj.Callback = function(TagName, IsChecked)
...
function GM_BattleHistory_C:OnRecordItemClicked(TagName, IsChecked)
    -- DebugPrint("Tianyi@ OnRecordItemClicked", TagName, IsChecked)
    -- if IsChecked then 
    --     self.BannedRecordTags[TagName] = nil
    -- else
    --     self.BannedRecordTags[TagName] = true
    -- end
    -- EMCache:Set("BannedRecordTags", self.BannedRecordTags)
    -- Battle(self):InitBannedRecordTags()
    self:UpdateData()
...
function GM_BattleHistory_C:OnPrintItemClicked(TagName, IsChecked)
    -- DebugPrint("Tianyi@ OnPrintItemClicked", TagName, IsChecked)
    -- if IsChecked then 
    --     self.BannedPrintTags[TagName] = nil
    -- else
    --     self.BannedPrintTags[TagName] = true
    -- end
    self:UpdateData()
end
