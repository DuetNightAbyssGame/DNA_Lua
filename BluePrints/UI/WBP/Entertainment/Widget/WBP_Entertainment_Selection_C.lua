...
---@type WBP_Entertainment_Selection_C
...
function M:SetIcon(IconPath)
	...
	UResourceLibrary.LoadObjectAsync(self, IconPath, {self, function(_, Icon)
		if self.IconPath ~= IconPath then return end
...
function M:Construct()
	self:BindToAnimationFinished(self.Click, {self, self.HandleOnClickAnimationFinished})
...
function M:Destruct()
	self:UnbindFromAnimationFinished(self.Click, {self, self.HandleOnClickAnimationFinished})
