...
---@class Entertainment_RoleListComponent
...
function Component:InitRoleContentList()
    ...
    for CharId, CharacterData in pairs(OwnedCharacterDataMap) do
        ...
        local Item = self:CreateRoleListItem(CharacterData, 
        bIsSelected)
...
function Component:InitRoleListView()
    ...
    --     self:EnsureFillListView()
    -- end, 2, "EnsureFillListView")
end
