---@class Entertainment_SequenceComponent
---@field EMListView_Role UEMListView
...
function Component:InitEntertainmentSequence()
    ...
    self.SequenceActor = self:GetWorld():SpawnActor(UE4.ALevelSequenceActor:StaticClass(),
        DefaultTrans, UE4.ESpawnActorCollisionHandlingMethod.AlwaysSpawn) --- @type ALevelSequenceActor
...
function Component:GetCineCameraActor(Tag)
    if not MiscUtils.IsActorValid(self.SequenceActor) then return end
