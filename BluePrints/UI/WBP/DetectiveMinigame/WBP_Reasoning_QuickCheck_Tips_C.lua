...
---@type WBP_Com_QuickCheck_Tips_C
...
function M:InitUIInfo(Name, IsInUIMode, EventList, ...)
    ...
    -- local Icon = LoadObject(DetectiveAnswerData.Icon)
    ...
    self:ListenForInputAction(self.MappingKeyName, EInputEvent.IE_Pressed, true, {self, self.OnClickOpen})
