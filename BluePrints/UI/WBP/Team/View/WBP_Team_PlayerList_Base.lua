...
---@class WBP_Team_PlayerList_Base:BP_UIState_C
local M = Class({"BluePrints.UI.BP_UIState_C"})

function M:Construct()
    M.Super.Construct(self)
    ---@type table<number,WBP_Team_PlayerItem_C>
    self.Teammate2UI = {}
    ...
    ---@param self WBP_Team_PlayerList_P_C
...
---@param ItemUI WBP_Team_PlayerItem_C
