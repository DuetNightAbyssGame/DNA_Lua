...
---@class WBP_Team_Main_Base :BP_UIState_C
...
function M:RegisterEvent()
    TeamController:RegisterEvent(self, function(self, EventId,...)
        ...
        elseif EventId == TeamCommon.EventId.TeamOnVoteStart
             or EventId == TeamCommon.EventId.TeamOnVoteInvalid 
             or EventId == TeamCommon.EventId.TeamOnVoteRefused 
             or EventId == TeamCommon.EventId.TeamOnVoteEntering then
