...
function M:Init(WeaponId, WeaponLevel, WeaponType)
    ...
    -- local TagIcon = LoadObject(TagIconPath)
    -- self.Icon_Info:SetBrushResourceObject(TagIcon)
    UE.UResourceLibrary.LoadObjectAsync(self,TagIconPath,{self,M.OnIconLoadFinish})
