...
---@type WBP_Team_PlayerList_P_C|WBP_Team_PlayerList_Base
...
function M:InitUIInfo(Name, bInUIMode, EventList, ...)
    ...
    self:OnMenuOpenChanged(false) --用来设置返回手柄按键UI的
...
function M:Close()
    ...
    --BattleMain.ChatFocusArea:SetVisibility(UIConst.VisibilityOp.Collapsed)
