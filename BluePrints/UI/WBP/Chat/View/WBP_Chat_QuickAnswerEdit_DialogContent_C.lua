...
---@type WBP_Chat_QuickAnswerEdit_C|Common_Dialog_ContentBase|TimerMgr
...
function M:PreInitContent(Parmas, PopupData, Owner)
    ...
    self.Changes = {}
    self.Owner.ForbiddenRightBtnClickedCallback = function()
    ...
    self.Owner.RightBtnClickedCallback = function()
...
function M:InitContent(Parmas, PopupData, Owner)
    ...
    -- self.Owner.Btn_Quit.SoundFunc = function()  
