...
---@type WBP_Pet_Capture_Detail_C
local WBP_Pet_Capture_Detail_C = Class({"BluePrints.UI.BP_UIState_C"})
...
function WBP_Pet_Capture_Detail_C:Construct()
    ...
    self.DetailItem = {
        {0.947307, 0.165132, 0.144128, 100},
        {0.947307, 0.401978, 0.174647, 80},
        {0.982251, 0.947307, 0.238398, 60},
        {0.341915, 0.775822, 0.287441, 40},
        {0.274677, 0.571125, 0.887923, 20},
        {0.187821, 0.318547, 0.715694, 1},
    }
...
function WBP_Pet_Capture_Detail_C:InitCaptureDetailItem()
    ...
    for i = 1, #self.DetailItem do
        ...
        Obj.Color = {ItemContent[1], ItemContent[2], ItemContent[3]}
