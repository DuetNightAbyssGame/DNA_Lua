...
function M:Construct()
    ...
    self.EntryWidgets = {self.EntryItem_1,self.EntryItem_2,self.EntryItem_3,self.EntryItem_4}
end
...
function M:UpdateEntryInfos(Pet)
    ...
    for i=1,4 do
        ...
        if(i > MaxEntry or Content.IsLocked or Content.IsEmpty)then
            if(Widget)then
...
function M:InitNavigationRules()
    ...
    elseif(#self.DisplayEntryItemWidgets == 2)then
    ...
    elseif(#self.DisplayEntryItemWidgets == 3)then
        local Widget1,Widget2,Widget3 = self.EntryItem_1,self.EntryItem_2,self.EntryItem_3
        Widget1:SetNavigationRuleBase(EUINavigation.Up, EUINavigationRule.Stop)
        Widget1:SetNavigationRuleBase(EUINavigation.Left, EUINavigationRule.Escape)
        Widget1:SetNavigationRuleExplicit(EUINavigation.Right, Widget2)
        Widget1:SetNavigationRuleCustom(EUINavigation.Down, {self, function()
        ...
        Widget2:SetNavigationRuleCustom(EUINavigation.Down, {self, function()
        ...
        Widget3:SetNavigationRuleCustom(EUINavigation.Up, {self, function()
    ...
    elseif(#self.DisplayEntryItemWidgets == 4)then
