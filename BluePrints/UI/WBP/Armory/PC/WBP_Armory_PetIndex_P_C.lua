...
---@type WBP_Armory_PetIndex_P_C
local M = Class({"BluePrints.UI.WBP.Armory.WBP_Armory_PetIndex_Base_C"})
...
function M:Construct()
    ...
    self.BottomKeyInfo = { {KeyInfoList = {{Type="Text", Text="Esc", ClickCallback=self.OnBackKeyDown, Owner=self}},
                            GamePadInfoList = {{Type="Img", ImgShortPath="B", ClickCallback=self.OnBackKeyDown, Owner=self}}, Desc=GText("UI_BACK")} },
...
function M:ModifySortWidgetParams(Params)
    ...
    Params.OnGetBackFocusWidget = function()
        return self.List_Item
    end
end
