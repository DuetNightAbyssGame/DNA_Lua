--- Armory_TraceAbilityItem_PC_C
---BluePrints.UI.WBP.Armory.Armory_TraceAbilityItem_PC_C
--- Generated by EmmyLua(https://github.com/EmmyLua)
--- Created by JuleszzZ.
--- DateTime: 2023/10/16 10:14
---
...
function M:PlayUnLockAnim()
    ...
    self.IsLock =  false
    --self:BindToAnimationFinished(self.UnLock, {self, PlayAnimFinished})
end
