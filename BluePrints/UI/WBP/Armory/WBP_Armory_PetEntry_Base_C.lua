...
--UIManager(self):LoadUI(UIConst.LoadInConfig, UIConfig.UIName,self:GetZOrder(),CommonConst.ArmoryType.Pet,self.ComparedPet,self,Params)
...
function M:UpdatePetInfos(Pet)
    ...
    local MaxLevel = Pet.Level -- UpgradeUtils.GetMaxLevel(Pet,"Pet")
