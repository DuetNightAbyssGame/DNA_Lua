...
function WBP_Play_Common_Item_C:OnListItemObjectSet(Content)
    ...
    self:SetNavigationRuleCustom(EUINavigation.Left,{self.Content.Parent,self.Content.Parent.OnUINavigation})
    self:SetNavigationRuleCustom(EUINavigation.Right,{self.Content.Parent,self.Content.Parent.OnUINavigation})
    ...
    if self.Content.Index - 1 == 0 then
