...
function M:Init(ConfigData)
    ...
    --     LeftGamePadKey = LeftTriggerThreshold  左快捷键（不传手柄端默认显示LT）
    --     RightGamePadKey = RightTriggerThreshold  右快捷键（不传手柄端默认显示RT）
