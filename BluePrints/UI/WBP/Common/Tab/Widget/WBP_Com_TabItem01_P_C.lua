...
function M:Construct()
    self.Btn_Click.OnClicked:Add(self, self.Btn_ClickFunction)
    self.Btn_Click.OnPressed:Add(self, self.Btn_Press)
    self.Btn_Click.OnHovered:Add(self, self.Btn_Hover)
    self.Btn_Click.OnUnhovered:Add(self, self.Btn_UnHover)
end
