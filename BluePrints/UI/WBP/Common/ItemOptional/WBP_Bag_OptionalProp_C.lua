...
function M:GetCurrentHoverItem()
    ...
    if Displayed then
        for i = 1, Displayed:Length() do
            ...
            -- if Entry and (Entry:IsHovered() or (Entry.HasAnyUserFocus and Entry:HasAnyUserFocus())) then
    ...
    -- return self.List_Prop:GetItemAt(index)
    return TargetWidget
end
