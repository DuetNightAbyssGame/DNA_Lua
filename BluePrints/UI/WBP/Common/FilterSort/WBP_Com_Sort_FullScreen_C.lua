...
function M:Construct()
    ...
    self:BindToAnimationFinished(self.List_In, {self,self.OnListInAnimFinished})
    self:UnbindAllFromAnimationFinished(self.List_Out)
    self:BindToAnimationFinished(self.List_Out, {self,self.OnListOutAnimFinished})
...
function M:OnListInAnimFinished()
    ...
    --     GameInputModeSubsystem:SetTargetUIFocusWidget(self.List)
    -- end
end
...
function M:OnKeyDown(MyGeometry, InKeyEvent)
    ...
    if(InKeyName == "Escape" and self.IsListViewOpened)then
        self:CloseList()
