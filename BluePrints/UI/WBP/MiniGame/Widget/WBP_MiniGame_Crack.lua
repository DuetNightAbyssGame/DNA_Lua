...
---@type WBP_MiniGame_Crack_C
local M = Class("BluePrints.UI.BP_UIState_C")

-- Param = {
--     RootPage        --小游戏主界面对象
--     SuccCallBack    --游戏成功的回调
--     ResetCallBack --游戏重置的逻辑
--     NeedCrack       --是否需要破解键，默认true
-- -    NeedReset     --是否需要重置键，默认true
-- }
...
function M:InitCrackButton()
    ...
    self.Key_Crack_GamePad:CreateCommonKey({KeyInfoList={
        {
            Type = "Img",
            ImgShortPath = "Y",
        },
    },})
    self.Key_Crack:CreateCommonKey({KeyInfoList = {{Type = "Text",Text = "F",}}})
...
function M:InitResetButton()
    ...
    self.Key_Reset_GamePad:CreateCommonKey({KeyInfoList={
        {
            Type = "Img",
            ImgShortPath = "X",
        },
