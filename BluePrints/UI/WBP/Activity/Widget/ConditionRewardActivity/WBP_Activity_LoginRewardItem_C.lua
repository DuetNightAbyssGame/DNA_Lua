...
---@type WBP_Activity_LoginReward_Item01_C
...
function M:OnBtnClicked()
    ...
    if (not self.ItemDetails_MenuAnchor.ItemDetailsMenuAnchor:IsOpen()) then
        local Content = {ItemType = self.ItemType, ItemId = self.Id, Uuid = self.Content.Uuid, 
                            MenuPlacement = self.Content.MenuPlacement, UIName = self.Content.UIName}
