...
function M:RefreshPageStaticView(ActivityConfigData, PageConfigData, PageServerData, InfoClickFunction, GachaClickFunction, GoToTargetPageFunction, 
                                    RewardGetClickFunction, ViewCharDetailFunction, SelectCharFunction, StuffDetailOpenFunction)
    -- 右上方标题相关
    ...
    if (PageConfigData.WalnutId) then
        ...
        if ActivityTryOutAvatarNeedWidget ~= nil then
