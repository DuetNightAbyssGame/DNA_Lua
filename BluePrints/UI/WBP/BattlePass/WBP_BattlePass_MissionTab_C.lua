...
---@type WBP_BattlePass_MissionTab_C
...
function M:InitNavigation()
    self:SetNavigationRuleCustom(EUINavigation.Up,{self.Root,self.Root.TryChangeSelectedTab})
    self:SetNavigationRuleCustom(EUINavigation.Down,{self.Root,self.Root.TryChangeSelectedTab})
    self:SetNavigationRuleCustom(EUINavigation.Right,{self.Root,self.Root.FocusToFirstMission})
end
