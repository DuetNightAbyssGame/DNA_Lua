...
---@type WBP_BattlePass_PetOption_C
...
function M:OnBtnChecked()
    --local Content = {ItemType = "Pet", ItemId = self.PetId, MenuPlacement = EMenuPlacement.MenuPlacement_MenuRight, IsShowDetails = true}
    --self.ItemDetails_MenuAnchor:OpenItemDetailsWidget(false, Content)
    UIManager(self):LoadUINew('ArmoryDetail',{PreviewPetIds = {self.PetId}, EPreviewSceneType = CommonConst.EPreviewSceneType.PreviewCommon})
end
