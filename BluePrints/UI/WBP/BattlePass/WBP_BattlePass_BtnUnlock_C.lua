...
---@type WBP_BattlePass_BtnUnlock_C
...
--    self.Text_Button:SetText(GText("UI_BattlePass_UnlockGoldRank"))
--end
...
function M:InitBtnInfo(State, Label, Callback,
                       bIsDiscount, OriginPrice, 
                       KeyShortPath, bLongPress)
