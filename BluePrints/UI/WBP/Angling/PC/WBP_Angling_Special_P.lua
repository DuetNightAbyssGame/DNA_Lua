...
function M:Init(RootPage, FishingSpotId)
    ...
    if self.RootPage.RootPage.DeviceInPc then
        -- self.Com_Key_Esc:CreateCommonKey({KeyInfoList = {{Type = "Text",Text = "Esc",}}})
        -- self.Key_Esc_GamePad:CreateCommonKey({KeyInfoList = {{Type = "Img",ImgShortPath = "B",}}})
        self.KeyText_E:CreateCommonKey({KeyInfoList = {{Type = "Text",Text = "E",}}})
        self.Key_E_GamePad:CreateCommonKey({KeyInfoList = {{Type = "Img",ImgShortPath = "A",}}})
    else
