...
---@type WBP_Angling_Fishing_Btn_C
local M = Class({"BluePrints.UI.BP_EMUserWidget_C"})

function M:Init(RootPage, bAutoPet)
    self.RootPage = RootPage
    self.bAutoPet = bAutoPet
    self.KeyText:CreateCommonKey({KeyInfoList = {{Type = "Text",Text = "Space",}}})
...
-- function M:OnAnimationInEnd()
--     print(_G.LogTag,"LXZ OnAnimationInEnd", self.bForbidden)
--     if not self.bForbidden then
--         self:PlayAnimation(self.Normal)
--     else
--         self:PlayAnimation(self.Forbidden)
