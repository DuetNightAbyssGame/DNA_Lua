...
---@type WBP_Camera_Screenshot_Item_C
...
function M:Construct()
    ...
    self:UnbindFromAnimationFinished(self.Click, {self, self.OnClickAnimEnd})
    self:BindToAnimationFinished(self.Click, {self, self.OnClickAnimEnd})
    self.Obj = nil
    self.Event = nil
