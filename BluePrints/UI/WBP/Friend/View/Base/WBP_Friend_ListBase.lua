...
---@class WBP_Friend_ListBase:BP_UIState
---@field protected ListDatas table
---@field protected MyListView UEMListView
---@field protected Parent WBP_Friend_MainBase
local M = Class(
...
function M:RefreshNavigationRule()
    if not FriendController:IsGamepad() then return end
    -- 遍历List_MyFriend，设置导航规则
