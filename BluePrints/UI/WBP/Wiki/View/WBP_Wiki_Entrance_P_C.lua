...
---@type WBP_Encyclopedia_Entrance_P_C
...
-- function M:CreateBookActor()
--     if self.BookActor then
--         self.BookActor:K2_DestroyActor()
--     end
--     local PlayerCharacter = UE4.UGameplayStatics.GetPlayerCharacter(self,0)
--     local PlayerTransform = PlayerCharacter:GetTransform()
--     self.BookActor = self:GetWorld():SpawnActor(LoadClass(WikiCommon.WikiBookBPPath), PlayerTransform, UE4.ESpawnActorCollisionHandlingMethod.AdjustIfPossibleButAlwaysSpawn, 
--                                                             PlayerCharacter, PlayerCharacter, self)
-- end
