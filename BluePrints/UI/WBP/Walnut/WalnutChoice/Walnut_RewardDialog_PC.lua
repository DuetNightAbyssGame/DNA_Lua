...
---@type WBP_Walnut_RewardDialog_M_C
local M = Class("BluePrints.UI.BP_UIState_C")

-- function M:Construct()
--     self:InitWalnutPlate(1001)
--     self:InitDescription(1001)
--     self:BindEvents()
-- end
...
-- function M:OnLoaded(...)
--     DebugPrint("WBP_Walnut_RewardDialog OnLoaded WalnutId: ", ...)
--     self:InitWalnutPlate(...)
...
-- self.State 
-- 0 初始 
-- self:UpdateCommonKeys("Menu", GText("UI_Controller_CheckPROB"), "LS", GText("UI_Controller_CheckReward"), "B", GText("UI_Controller_Close"))
-- 1 查看概率  
...
function M:OnKeyDown(MyGeometry, InKeyEvent)
    ...
    if (UE4.UKismetInputLibrary.Key_IsGamepadKey(InKey)) then
        ...
        --PC
        if InKeyName == "Escape" and self.IsAllowEscape then
