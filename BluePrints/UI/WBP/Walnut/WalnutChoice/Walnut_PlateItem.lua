...
function M:OpenDetailWidget(ItemType, ItemId, Placement)
    self.Content = {ItemType = ItemType, ItemId = ItemId,
    MenuPlacement = Placement or EMenuPlacement.MenuPlacement_MenuRight, UIName = "WalnutChoice"}
