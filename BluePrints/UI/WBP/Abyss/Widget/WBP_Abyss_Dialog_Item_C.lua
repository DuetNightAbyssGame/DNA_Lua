        ...
        function()
            local AllItemCount=self.List_Item_L:GetNumItems()
             for i = 0, AllItemCount - 1, 1 do
                ...
                if  Item.SelfWidget then
                    --Item.SelfWidget:ItemSetNavigationRuleCustom(self,self.OnUINavigation)
                    ...
                    Item.SelfWidget:SetNavigationRuleCustom(UE4.EUINavigation.Up, {self, self.OnNavigateUp})
                    Item.SelfWidget:SetNavigationRuleCustom(UE4.EUINavigation.Down, {self, self.OnNavigateDown})
                end
            end
...
function M:OnKeyDown(MyGeometry, InKeyEvent)
    ...
    if UE4.UKismetInputLibrary.Key_IsGamepadKey(InKey) then
        ...
        elseif  InKeyName == UIConst.GamePadKey.FaceButtonBottom then
            IsEventHandled=true
            if self.Switch_Btn:GetActiveWidgetIndex() == 0 then
