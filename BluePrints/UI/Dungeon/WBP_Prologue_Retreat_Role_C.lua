...
--function WBP_Prologue_Retreat_Role_C:Initialize(Initializer)
--end

--function WBP_Prologue_Retreat_Role_C:PreConstruct(IsDesignTime)
--end

-- function WBP_Prologue_Retreat_Role_C:Construct()
-- end

--function WBP_Prologue_Retreat_Role_C:Tick(MyGeometry, InDeltaTime)
--end
