...
---@class WBP_DungeoneMatchingFloat_C : Team_Countdown
local WBP_DungeoneMatchingFloat_C = Class("BluePrints.UI.BP_UIState_C")

--function WBP_DungeoneMatchingFloat_C:Initialize(Initializer)
--end

--function WBP_DungeoneMatchingFloat_C:PreConstruct(IsDesignTime)
--end

-- function WBP_DungeoneMatchingFloat_C:Construct()
