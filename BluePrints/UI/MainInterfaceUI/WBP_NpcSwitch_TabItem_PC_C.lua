...
function WBP_NpcSwitch_TabItem_PC_C:UpdateTabItem(TabContent)
    self.TabName = {GText("UI_SHOWNPC_NAME_SCENE1"), GText("UI_SHOWNPC_NAME_SCENE2"), GText("UI_SHOWNPC_NAME_SCENE3")}
    ...
    if self.SignBoardNpcState[TabContent.TabId] ==-1 then
        ...
        local ResId = ""
        local NpcIcon = ""
        if CharModel ~= nil and CharModel.StandId ~= nil then
