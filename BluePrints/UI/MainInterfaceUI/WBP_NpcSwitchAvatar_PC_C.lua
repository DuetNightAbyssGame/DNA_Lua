--WBP_NpcSwitchAvatar_PC_C

require "UnLua"

local N = Class({"BluePrints.UI.BP_EMUserWidget_C"})
...
function N:SetImgAvatar()
    ...
    --self.Img_Avatar:SetBrushResourceObject(NpcIcon)
    ...
    --if self.RarityColor:Length() >= Rarity then
    --    self.Quality.Img_Quality:SetColorAndOpacity(self.RarityColor:GetRef(Rarity))
    --end
