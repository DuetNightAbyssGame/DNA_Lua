...
function WBP_Common_BattleMap_Icon_PC:ChangeHostageIconStyle(IsDead)
    ...
    UE4.UResourceLibrary.LoadObjectAsync(self,Path,{self,WBP_Common_BattleMap_Icon_PC.OnHostageIconLoadFinish})
    -- if self.IsHostage and IsDead then
    --     self.Icon:SetBrushResourceObject(LoadObject('/Game/UI/Texture/Dynamic/Atlas/GuidePoint/T_Gp_Rescue_HostageB.T_Gp_Rescue_HostageB'))
    -- else
    --     self.Icon:SetBrushResourceObject(LoadObject('/Game/UI/Texture/Dynamic/Atlas/GuidePoint/T_Gp_Rescue_HostageA.T_Gp_Rescue_HostageA'))
    -- end
end
