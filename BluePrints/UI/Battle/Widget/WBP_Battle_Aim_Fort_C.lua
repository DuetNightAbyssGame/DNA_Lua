...
function WBP_Battle_Aim_Fort_C:RefreshAimColorByState(ActorRelation)
    -- if self:IsAnimationPlaying(self.Kill) then
    --     return
    -- end
    if ActorRelation == "Default" then
...
function WBP_Battle_Aim_Fort_C:TryToPlayAimDiffusionStartAnim()
    ...
    if self.CurActorRelation == "Friend" or self.CurActorRelation == "Enery" then
