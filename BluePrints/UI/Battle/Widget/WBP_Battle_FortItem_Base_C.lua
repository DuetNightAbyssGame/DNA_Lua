...
function WBP_Battle_FortItem_Base_C:InitItem_PaoTai(SkillName, Skill, OwnerPlayer, Index, Root)
    ...
    self.BuffsAddedDelegate = function() self:OnBuffAdded() end
    self.BuffsRemovedDelegate = function() self:OnBuffRemoved() end
...
function WBP_Battle_FortItem_Base_C:OnBuffAdded()
    ...
    self:BindToAnimationFinished(self.Cutdown,{self,self.PlayCutdownAnimation})
...
function WBP_Battle_FortItem_Base_C:OnBuffRemoved()
    self:UnbindAllFromAnimationFinished(self.Cutdown)
    -- if EMUIAnimationSubsystem:EMAnimationIsPlaying(self.Cutdown) then
    --     EMUIAnimationSubsystem:EMStopAnimation(self.Cutdown)
    -- end
...
function WBP_Battle_FortItem_Base_C:PlayCutdownAnimation()
    -- EMUIAnimationSubsystem:EMPlayAnimation(self, self.Cutdown)
