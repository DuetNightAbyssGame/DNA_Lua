...
function WBP_NPC_Bubble_Reward_C:OnEnabled()
    ...
    --DebugPrint("WBP_NPC_Bubble_Reward_C:OnEnabled", Content, Style, Time, self.Panle_Main:GetRenderOpacity(),"vis:", self:GetVisibility())
...
function WBP_NPC_Bubble_Reward_C:SwitchEnableEmoBubble(bEnable)
    --DebugPrint("WBP_NPC_Bubble_Reward_C:SwitchEnableEmoBubble", bEnable)
    if bEnable then
