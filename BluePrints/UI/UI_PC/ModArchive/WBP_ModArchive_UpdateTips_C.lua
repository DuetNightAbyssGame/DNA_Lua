...
function WBP_ModArchive_UpdateTips_C:OnClose()
    ...
    self:UnbindFromAnimationFinished(self.Out, {self, self.RealOnClose})
    self:BindToAnimationFinished(self.Out, {self, self.RealOnClose})
...
-- 监听松开按键
-- function WBP_ModArchive_UpdateTips_C:OnKeyUp(MyGeometry, InKeyEvent)
...
-- 手柄按键松开
-- function WBP_ModArchive_UpdateTips_C:Handle_OnGamePadUp(InKeyName)
