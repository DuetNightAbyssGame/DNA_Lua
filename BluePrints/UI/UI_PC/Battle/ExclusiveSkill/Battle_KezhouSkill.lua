...
-- 详细规则见: https://www.tapd.cn/31626021/prong/stories/view/1131626021001215052
function M:OnBuffsChanged(Buffs)
    ...
    if bInMeleeWeakState then
        ...
        if MeleeBuffLayer == self.MaxMeleeBuffLayer then
