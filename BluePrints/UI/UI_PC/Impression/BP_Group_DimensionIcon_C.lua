---@type BP_Group_DimensionIcon_C
local BP_Group_DimensionIcon_C = Class("BluePrints.UI.BP_EMUserWidget_C")

-- function BP_Group_DimensionIcon_C:Initialize(Initializer)
-- end

-- function BP_Group_DimensionIcon_C:PreConstruct(IsDesignTime)
-- end

-- function BP_Group_DimensionIcon_C:Construct()
-- end

-- function BP_Group_DimensionIcon_C:Tick(MyGeometry, InDeltaTime)
-- end
