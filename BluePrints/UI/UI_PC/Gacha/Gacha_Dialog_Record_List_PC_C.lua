...
function G:OnListItemObjectSet(Content)
    ...
    local RarityText
    if GachaCommon.GachaItemTypeMap[Content.ItemType] == "Skin" or
    GachaCommon.GachaItemTypeMap[Content.ItemType] == "WeaponSkin" or 
    GachaCommon.GachaItemTypeMap[Content.ItemType] == "CharAccessory" or 
    GachaCommon.GachaItemTypeMap[Content.ItemType] == "WeaponAccessory" then
