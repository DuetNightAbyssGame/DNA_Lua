...
function G:OnBtnPressed()
    if self.IsSelected or self.IsEmpty then return end
...
function G:OnBtnHovered()
    if self.IsSelected or self.IsEmpty then return end
    if not self.Obj.ParentWidget.IsPCPlatform then return end
    -- if UIUtils.UtilsGetCurrentInputType() == ECommonInputType.Gamepad then
    --     if not self.Obj.ParentWidget.CantClick then
    --         self:OnBtnClicked()
    --     end
    --     return
    -- end
