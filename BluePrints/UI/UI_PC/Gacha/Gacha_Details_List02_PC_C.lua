--- Gacha_Details_List02_PC_C
--- Generated by EmmyLua(https://github.com/EmmyLua)
--- Created by A.
--- DateTime: 2023/6/14 14:54
---
...
function G:OnListItemObjectSet(Obj)
    ...
    self.StarLevel = Obj.TargetRarity
                --CommonConst.GACHA_PROBABILITY_BASE
...
function G:SetGachaProbability(IsUp)
    if IsUp then
        ...
        if self.StarLevel == 3 then
            Probability = CommonConst.GACHA_PROBABILITY_BASE
                    - GachaProbabilityInfo['ProbabilityStar4']
                    - GachaProbabilityInfo['ProbabilityStar5']
        else
...
function G:InitUpListItem()
    ...
    if CurListNums > Count then
        for index = Count + 1,CurListNums,1 do
...
function G:OpenShowCharDetail(CharId)
    ...
    UIManager(self):LoadUINew("ArmoryDetail",{
        ...
        OnCloseDelegate = {
            GachaMain,GachaMain.OnClickBtnRecord
        }
    })
end
