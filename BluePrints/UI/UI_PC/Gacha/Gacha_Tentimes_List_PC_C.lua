---Gacha_Tentimes_List_PC_C
--- Generated by EmmyLua(https://github.com/EmmyLua)
--- Created by JuleszzZ.
--- DateTime: 2023/6/13 19:54
---
...
function G:Init(Parent,TargetType,TargetId,IsNew,IsOdd)
    ...
    --self:SetTargetImgRole(TargetType,TargetId)
...
function G:SetTargetRarity(Rarity)
    ...
    if self.IsNeedChange then
        ...
        if not self.IsNew and self.TargetType == CommonConst.GachaCharType then
...
function G:CheckCharGradeCanMax(CharId)
    ...
    local AlreadyGetCount = self.Parent.ThisTimeGetChar[CharId] --目前已经抽到的排序
