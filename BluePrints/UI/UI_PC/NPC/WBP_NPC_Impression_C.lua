...
function WBP_NPC_Impression_C:OnEnabled()
    --DebugPrint("@@@ OnEnabled Impression",self.bIsEnabled_Impression)
...
function WBP_NPC_Impression_C:OnDisabled()
    -- DebugPrint("@@@ On Disabled Impression",self.bIsEnabled_Impression)
...
function WBP_NPC_Impression_C:OnOutAnimationFinished()
    --DebugPrint("@@@ On Impression Animation Finished")
    self:SetVisibility(UE4.ESlateVisibility.Collapsed)
end
