--- Setting_Scroll_Option_PC_C
--- Generated by EmmyLua(https://github.com/EmmyLua)
--- Created by JuleszzZ.
--- DateTime: 2023/8/25 15:03
---
...
function S:GetBottomKeyInfos()
    return {{UIConst.GamePadImgKey.FaceButtonRight, GText("UI_BACK")}}
end
...
--     if self['Restore'..self.CacheName..'OldValueSet'] then
--         self['Restore'..self.CacheName..'OldValueSet'](self)
--     end
-- end
...
-- function S:SetTotalVolumeSetting()
--     AudioManager(self):SetBusVolume(self.EMCacheKey,self.NowValue / self.SlideMaxValue)
-- end
...
-- function S:RestoreTotalVolumeOldValueSet()
--     AudioManager(self):SetBusVolume(self.EMCacheKey,self.OldValue / self.SlideMaxValue)
-- end
...
-- function S:RestoreMusicVolumeOldValueSet()
--     AudioManager(self):SetBusVolume(self.EMCacheKey,self.OldValue / self.SlideMaxValue)
-- end
...
-- function S:RestoreVoiceVolumeOldValueSet()
--     AudioManager(self):SetBusVolume(self.EMCacheKey,self.OldValue / self.ScrollMappingScale)
-- end
...
-- function S:RestoreSoundVolumeOldValueSet()
--     AudioManager(self):SetBusVolume(self.EMCacheKey,self.OldValue / self.ScrollMappingScale)
-- end


-----------------------水平灵敏度相关 HorizontalSensitivity-------------------------
...
-----------------------射击水平灵敏度相关 HorizontalSensitivityOnShooting-------------------------
...
-----------------------射击垂直灵敏度相关 VerticalSensitivityOnShooting-------------------------
...
-----------------------手柄水平灵敏度 GamePadHorizontalSensitivity-------------------------
...
-----------------------手柄射击时水平灵敏度 GamePadHorizontalSensitivityOnShooting-------------------------
...
-----------------------手柄射击时垂直灵敏度 GamePadVerticalSensitivityOnShooting-------------------------
