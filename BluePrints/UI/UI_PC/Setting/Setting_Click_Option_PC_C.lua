--- Setting_Click_Option_PC_C
--- Generated by EmmyLua(https://github.com/EmmyLua)
--- Created by JuleszzZ.
--- DateTime: 2023/8/25 16:39
---
...
function S:OnReleaseStuckClicked()
    ...
    if not self:HasValidPortal() then
        ...
        --UIManager(self):ShowCommonPopupUI_Old(100048, self, self.ResetLocation)
    --else
        --UIManager(self):ShowUITip("CommonToastMain", DataMgr.TextMap["UI_Tosat_Release_Stuck"].TextMapContent,1)
    end
end
...
-----------------------客服入口相关 CustomerService-------------------------
function S:OnServiceReddotChange(Count)
    -- DebugPrint("Tianyi@ Setting_Click_Option_PC_C:OnServiceReddotChange "..tostring(Count))
    if Count > 0 then
