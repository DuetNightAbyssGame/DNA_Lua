...
function WBP_Pet_Capture_C:Construct()
    ...
    if self.Key_Throw then
        self.Key_Throw:CreateCommonKey({
            KeyInfoList = {{Type = "Text", Text = "SpaceBar"}},
        })
    end
...
function WBP_Pet_Capture_C:OnLoaded(Owner)
    ...
    local PetType = self.PetData.PetType == 1 and "Pet_BattlePet" or "Pet_ResourcePet"
    self.Color_Bar.Text_Activation:SetText(GText(PetType))
    self.Color_Bar.Text_Inactivation:SetText(GText(PetType))
    self.Color_Bar.WS_Attribute:SetActiveWidgetIndex(self.PetData.PetType == 1 and 0 or 1)
    --播放宠物待机音效
...
function WBP_Pet_Capture_C:InitGamepadUI()
    ...
    self.Snack_Green.Button_Area:SetNavigationRuleCustom(EUINavigation.Up, {self, function()
        self.CurFocusWidget = self.Snack_Green.Item_Snacks
        return self.Snack_Green.Item_Snacks
    end})
    self.Snack_Blue.Button_Area:SetNavigationRuleCustom(EUINavigation.Up, {self, function()
        self.CurFocusWidget = self.Snack_Blue.Item_Snacks
        return self.Snack_Blue.Item_Snacks
    end})
    self.Snack_Purple.Button_Area:SetNavigationRuleCustom(EUINavigation.Up, {self, function()
        self.CurFocusWidget = self.Snack_Purple.Item_Snacks
        return self.Snack_Purple.Item_Snacks
    end})
    self.Snack_Gold.Button_Area:SetNavigationRuleCustom(EUINavigation.Up, {self, function()
        self.CurFocusWidget = self.Snack_Gold.Item_Snacks
        return self.Snack_Gold.Item_Snacks
    end})
    
    self.Snack_Green.Button_Area:SetNavigationRuleCustom(EUINavigation.Right, {self, function()
        self.CurFocusWidget = self.Snack_Blue.Button_Area
        return self.Snack_Blue.Button_Area
    end})
    self.Snack_Blue.Button_Area:SetNavigationRuleCustom(EUINavigation.Left, {self, function()
        self.CurFocusWidget = self.Snack_Green.Button_Area
        return self.Snack_Green.Button_Area
    end})
    self.Snack_Blue.Button_Area:SetNavigationRuleCustom(EUINavigation.Right, {self, function()
        self.CurFocusWidget = self.Snack_Purple.Button_Area
        return self.Snack_Purple.Button_Area
    end})
    self.Snack_Purple.Button_Area:SetNavigationRuleCustom(EUINavigation.Left, {self, function()
        self.CurFocusWidget = self.Snack_Blue.Button_Area
        return self.Snack_Blue.Button_Area
    end})
    self.Snack_Purple.Button_Area:SetNavigationRuleCustom(EUINavigation.Right, {self, function()
        self.CurFocusWidget = self.Snack_Gold.Button_Area
        return self.Snack_Gold.Button_Area
    end})
    self.Snack_Gold.Button_Area:SetNavigationRuleCustom(EUINavigation.Left, {self, function()
        self.CurFocusWidget = self.Snack_Purple.Button_Area
        return self.Snack_Purple.Button_Area
    end})

    self.Snack_Green.Item_Snacks:SetNavigationRuleCustom(EUINavigation.Right, {self, function()
        self.CurFocusWidget = self.Snack_Blue.Item_Snacks
        return self.Snack_Blue.Item_Snacks
    end})
    self.Snack_Blue.Item_Snacks:SetNavigationRuleCustom(EUINavigation.Left, {self, function()
        self.CurFocusWidget = self.Snack_Green.Item_Snacks
        return self.Snack_Green.Item_Snacks
    end})
    self.Snack_Blue.Item_Snacks:SetNavigationRuleCustom(EUINavigation.Right, {self, function()
        self.CurFocusWidget = self.Snack_Purple.Item_Snacks
        return self.Snack_Purple.Item_Snacks
    end})
    self.Snack_Purple.Item_Snacks:SetNavigationRuleCustom(EUINavigation.Left, {self, function()
        self.CurFocusWidget = self.Snack_Blue.Item_Snacks
        return self.Snack_Blue.Item_Snacks
    end})
    self.Snack_Purple.Item_Snacks:SetNavigationRuleCustom(EUINavigation.Right, {self, function()
        self.CurFocusWidget = self.Snack_Gold.Item_Snacks
        return self.Snack_Gold.Item_Snacks
    end})
    self.Snack_Gold.Item_Snacks:SetNavigationRuleCustom(EUINavigation.Left, {self, function()
        self.CurFocusWidget = self.Snack_Purple.Item_Snacks
        return self.Snack_Purple.Item_Snacks
    end})
    
    self.Snack_Green.Item_Snacks:SetNavigationRuleCustom(EUINavigation.Down, {self, function()
        self.CurFocusWidget = self.Snack_Green.Button_Area
        return self.Snack_Green.Button_Area
    end})
    self.Snack_Blue.Item_Snacks:SetNavigationRuleCustom(EUINavigation.Down, {self, function()
        self.CurFocusWidget = self.Snack_Blue.Button_Area
        return self.Snack_Blue.Button_Area
    end})
    self.Snack_Purple.Item_Snacks:SetNavigationRuleCustom(EUINavigation.Down, {self, function()
        self.CurFocusWidget = self.Snack_Purple.Button_Area
        return self.Snack_Purple.Button_Area
    end})
    self.Snack_Gold.Item_Snacks:SetNavigationRuleCustom(EUINavigation.Down, {self, function()
        self.CurFocusWidget = self.Snack_Gold.Button_Area
        return self.Snack_Gold.Button_Area
    end})
end
...
function WBP_Pet_Capture_C:OnKeyDown(MyGeometry, InKeyEvent)
    ...
    elseif InKeyName == "Escape" or InKeyName == "Gamepad_FaceButton_Right" then
        self:ExitPetCapture()
    elseif InKeyName == "Gamepad_FaceButton_Left" and not self.SelectStart then
        self:OnConfirmClicked()
    ...
    (
        {
            ...
            BottomKeyInfo = {
                ...
                {
                    KeyInfoList = {{Type="Text", Text = "Esc", ClickCallback = self.ExitPetCapture, Owner = self}},
                    GamePadInfoList = {{Type = "Img", ImgShortPath = "B", ClickCallback = self.ExitPetCapture, Owner = self}},
                    Desc = GText("UI_Tips_Close")
                },
            },
           StyleName = "Text", OwnerPanel = self, BackCallback = self.ExitPetCapture
        }
    )
end
...
function WBP_Pet_Capture_C:ShowSpecialPet(IsShow)
    ...
    if IsShow then
        ...
        self.Owner.FXComponent:PlayEffectByIDParams(301, {
        ...
        self.Owner:UpdateModelSkin(ModelConfig.PetModelId)
        self.Owner.FXComponent:PlayEffectByIDParams(302, {
            bTickEvenWhenPaused = true,
            NotAttached = true
        })
...
function WBP_Pet_Capture_C:PressSnackButton(PressButton, SnackId, Level)
    ...
    for i = 1, #self.ProbabilityPercent do
        ...
        if ProbabilityItem.Probability >= PetFavFoodThreshold and ProbabilityItem.Percent > 0 then
            self:PlayPetVoice(PetBehavior.Hello)
            return
        end
    end
...
function WBP_Pet_Capture_C:InitSnackButton(SnackButton, SnackId)
    ...
    SnackButton:BindToAnimationFinished(SnackButton.UnHover, {SnackButton, function()
        local Avatar = GWorld:GetAvatar()
        if not Avatar then
            return
        end
...
function WBP_Pet_Capture_C:OnConfirmClicked()
    ...
    self:BindToAnimationFinished(self.Tip_In, {self, self.StartSelect})
...
function WBP_Pet_Capture_C:MoveRightSelectArrow()
    local Padding = UE4.FMargin(0, 0, 0, 0)
    local MiniGameConfig = DataMgr.MiniGameCapture[self.PetData.MiniGameCaptureId]
    self.MoveSelectArrowHandle = ULTweenBPLibrary.FloatTo(self, {self, function(_, Value)
    ...
    end }, -298, 298, MiniGameConfig.PointerSpeed, 0, 0)
end
...
function WBP_Pet_Capture_C:ThrowSnack()
    ...
    CommonUtils:CloseGuideTouchIfExist(self) -- todo 临时处理
...
function WBP_Pet_Capture_C:TryCapturePet()
    ...
    local Padding = UE4.FMargin(0, 0, 0, 0)
    if self.ArrowValue <= Interval then
    ...
    elseif self.ArrowValue > Interval then
    ...
    local RPCCallback = function (ErrCode, UniqueId)
        self.ExistReason = 2
        ...
        if (IsValid(SceneMgrComponent)) then
            if self.Owner.Eid == SceneMgrComponent.NearestPetGuideEid then
    ...
    if self.Owner.DynamicUniqueId ~= 0 then
...
function WBP_Pet_Capture_C:UpdateFoodLvProbability(FoodLv)
    local GameMode = UGameplayStatics.GetGameMode(self.Owner)
    if not (self.Owner.DynamicUniqueId ~= 0) and not (GameMode and GameMode:IsInRegion()) then
        FoodLv = -0.99
    end
    local Probability = {1, 0.8, 0.6, 0.4, 0.2}
    local MiniGameConfig = DataMgr.MiniGameCapture[self.PetData.MiniGameCaptureId]
    ...
    for i = 1, #Probability do
        ...
        if Percent > 0 then
            ...
            table.insert(self.ProbabilityPercent, {Percent = Percent, Probability = Probability[i], Value = Value})
            SizeStruct.Value = Value
            local CurColorValue = self.CurColorBarSize[i] and self.CurColorBarSize[i].CurValue or Value
            self.CurColorBarSize[i] = {TargetValue = Value, CurValue = CurColorValue, ColorIndex = Index}
            PrePercent = Percent
        else
            SizeStruct.Value = 0
            local CurColorValue = self.CurColorBarSize[i] and self.CurColorBarSize[i].CurValue or 0
            self.CurColorBarSize[i] = {TargetValue = 0, CurValue = CurColorValue, ColorIndex = Index}
        end
    end
    table.insert(self.ProbabilityPercent, {Percent = 1, Probability = 0.01, Value = 1 - PrePercent})
    local SizeStruct = FSlateChildSize()
    ...
    self.CurColorBarSize[6] = {TargetValue = Value, CurValue = CurColorValue, ColorIndex = 6}
    ...
    if #self.ProbabilityPercent >= 1 and self.ProbabilityPercent[1].Probability == 1 and self.ProbabilityPercent[1].Percent == 1 then
...
function WBP_Pet_Capture_C:PlayProbabilityAnimation()
    ...
    self.ProbabilityHandle = ULTweenBPLibrary.FloatTo(self, {self, function(_, Value)
        for i = 1, #self.CurColorBarSize do
            local ColorBar = self.CurColorBarSize[i]
 ...
 --function WBP_Pet_Capture_C:ShowCaptureProbability()
 --    local UIManager = GWorld.GameInstance:GetGameUIManager()
 --    if not UIManager then
 --        return
 --    end
 --    UIManager:LoadUINew("PetCaptureDetail")
 --end
...
function WBP_Pet_Capture_C:MoveCamera(Camera, IsSelecting)
    ...
    if IsSelecting then
        ...
        end }, EndLocation, EndLocation - CamOffset, 0.5, 0, 17)
    else
        self.CameraHandle = ULTweenBPLibrary.Vector3To(self,{self, function(_, Value)
            Camera:K2_SetRelativeLocation(Value, false, nil, false)
        end }, StartLocation, EndLocation, 0.5, 0, 17)
    end
end
