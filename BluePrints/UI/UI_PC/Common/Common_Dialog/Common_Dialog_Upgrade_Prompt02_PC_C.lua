...
---@class Common_Dialog_Upgrade_Prompt02_PC:Common_Dialog_Upgrade_Prompt02_PC_C
...
function M:SequenceEvent_PlayAttrAnim()
    ...
    UIUtils.StopListViewFramingInAnimation(self.NowListView,{TimerKeys = self.FramingInTimers, UIState =self}) -- 重置动画状态
    self:AddTimer(0.01, function()
        self.FramingInTimers = UIUtils.PlayListViewFramingInAnimation(self, self.NowListView, {Visibility=UIConst.VisibilityOp.HitTestInvisible,Callback = function()
...
function M:OnOutAnimationFinished()
    ...
    UIUtils.StopListViewFramingInAnimation(self.NowListView, {TimerKeys = self.FramingInTimers, UIState = self})
end
