...
---@class WBP_Common_Dialog_Birth_PC_C: WBP_Common_Dialog_Birth_PC_C
---@field NumberScroll_Month WBP_Common_Dialog_NumberScroll_PC_C
---@field NumberScroll_Day WBP_Common_Dialog_NumberScroll_PC_C
...
function WBP_Common_Dialog_Birth_PC_C:GamepadFocusMonth()
    if self.FocusBirthScrollWidget == self.NumberScroll_Month then return end
...
function WBP_Common_Dialog_Birth_PC_C:GamepadFocusDay()
    if self.FocusBirthScrollWidget == self.NumberScroll_Day then return end
...
function WBP_Common_Dialog_Birth_PC_C:OnMonthSelected(Month)
    ...
    --self.NumberScroll_Day:ResetNumbers(Days)
    self.NumberScroll_Day.NumberRequired=Days
    if self.NumberScroll_Day:GetSelectedNumber() ~=1 then
