...
---@class Common_Dialog_Attr02_PC: Common_Dialog_Attr02_PC ,Common_Dialog_ContentBase
...
function M:PlayInAnim()
    UIUtils.StopListViewFramingInAnimation(self.ListView_Attr, {TimerKeys = self._ListInTimers,UIState = self})
