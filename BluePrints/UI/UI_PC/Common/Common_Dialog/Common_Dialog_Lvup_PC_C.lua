...
---@class Common_Dialog_Lvup_PC: Common_Dialog_Lvup_PC_C,Common_Dialog_ContentBase
...
function M:Construct()
    ...
    self.Btn_Reduce:BindForbidStateExecuteEvent(self, function(self) self:OnSubBtnForbid() end)
    self.Btn_Add:BindForbidStateExecuteEvent(self, function(self) self:OnAddBtnForbid() end)
    self.Btn_Add_Max:BindEventOnClicked(self, function(self) self:OnBtnAddMaxClicked() end)
    self.Btn_Reduce_Max:BindEventOnClicked(self, function(self) self:OnBtnReduceMaxClicked() end)
    self.Btn_Reduce_Max:BindForbidStateExecuteEvent(self, function(self) self:OnSubMaxBtnForbid() end)
    self.Btn_Add_Max:BindForbidStateExecuteEvent(self, function(self) self:OnAddMaxBtnForbid() end)
    ...
    self.Btn_Reduce.SoundFunc = function(Btn)
        if Btn.IsForbidden then
    ...
    self.Btn_Add_Max.SoundFunc = function(Btn)
        if Btn.IsForbidden then
    ...
    self.Btn_Reduce_Max.SoundFunc = function(Btn)
        if Btn.IsForbidden then
