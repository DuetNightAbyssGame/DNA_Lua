...
function Common_Key_Hud_PC:SetUpVisible(Style)
    ...
    elseif(Style=="Single") then
        ...
        --     self.Panel_LongPress_1:SetVisibility(UE4.ESlateVisibility.SelfHitTestInvisible)
        --     self.Panel_Press_1:SetVisibility(UE4.ESlateVisibility.Collapsed)
        -- else
        --     self.Panel_LongPress_1:SetVisibility(UE4.ESlateVisibility.Collapsed)
        --     self.Panel_Press_1:SetVisibility(UE4.ESlateVisibility.SelfHitTestInvisible)
        -- end
    else
        ...
        --     self.Panel_Press:SetVisibility(UE4.ESlateVisibility.Collapsed)
        -- else
        --     self.Panel_LongPress:SetVisibility(UE4.ESlateVisibility.Collapsed)
        --     self.Panel_Press:SetVisibility(UE4.ESlateVisibility.SelfHitTestInvisible)
        -- end
    end
end
...
-- function Common_Key_Hud_PC:OnMouseButtonUp(MyGeometry, InKeyEvent)
