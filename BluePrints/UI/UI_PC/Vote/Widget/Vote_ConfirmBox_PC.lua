...
function M:InitContinue(Type)
    ...
    -- self.Text_CostContent:SetText(GText("UI_Vote_Continue_Cost"))
    ...
    self.Cost.Common_Item_Icon:BindEvents(self.VoteMain, {OnMenuOpenChanged = self.VoteMain.OnItemMenuOpenChanged})
...
function M:InitLeave(Type)
    ...
    -- self.Btn_Leave:SetIcon('/Game/UI/UI_PNG_Static/Atlas/Common/Icon_Leave.Icon_Leave')
    ...
    -- self.Btn_Leave:AddPressLogic(self, self.OnPressLeave)
...
function M:OnPressContinue()
    ...
    -- self:AddTimer(0.1, self.OnGamepadPressContinue, true, 0, "OnGamepadPressContinue")
end
...
function M:GetActionPoint()
    ...
    -- print(_G.LogTag,"LXZ GetActionPoint",CurrentCostIdx, self.VoteMain.CurrentWave, MaxCostWave)
    ...
    -- self.Text_Expend:SetText(self.CurrentActionPoint)
    -- if self.CurrentActionPoint >= self.CostActionPoint then
    --     self.Text_Expend:SetColorAndOpacity(UE4.UUIFunctionLibrary.StringToSlateColor("107144"))
    -- else
    --     self.Text_Expend:SetColorAndOpacity(UE4.UUIFunctionLibrary.StringToSlateColor("B9020F"))
    -- end
    -- self.Text_Possess:SetText(self.CostActionPoint)
end
