...
function WBP_Rouge_Treasure_C:ShowItemDetail()
    if self.TreasureItemData then
        self.Content = {ItemType = "RougeLikeTreasure", ItemId = self.TreasureItemData.TreasureId, MenuPlacement = EMenuPlacement.MenuPlacement_MenuRight, UIName = "RougeSettlement"}
    else
        self.Content = {ItemType = "RougeLikeTreasure", MenuPlacement = EMenuPlacement.MenuPlacement_MenuRight, Name = "RLTreasure_Name_Unknown"}
    end
