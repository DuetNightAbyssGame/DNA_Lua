...
---@class WBP_Rouge_Contract_ViewBase : WBP_Rouge_Heat_P_C
...
function WBP_Rouge_Contract_ViewBase:InitGamepadView()
    ...
    self.Icon_Key_illustrate:CreateCommonKey({KeyInfoList = {{
        Type = "Img",
        ImgLongPath = UIUtils.UtilsGetKeyIconPathInGamepad("Menu", self.CurGamepadName)}
    }})
    self.Icon_Key_Reset:CreateCommonKey({KeyInfoList = {{
        Type = "Img",
        ImgLongPath = UIUtils.UtilsGetKeyIconPathInGamepad("Y", self.CurGamepadName)}
    }})
    self.Icon_Key_Confirm:CreateCommonKey({KeyInfoList = {{
        Type = "Img",
