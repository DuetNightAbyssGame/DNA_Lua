...
---@class WBP_Rouge_Contract_View : WBP_Rouge_Heat_P_C
...
function WBP_Rouge_Menu_Contract_View:ShowGamepadKeyInfo()
    ...
    local CanScroll = UIUtils.GetListViewContentMaxCount(self.List_Heat) < ItemTotalNum
...
function WBP_Rouge_Menu_Contract_View:OnAnalogValueChanged(MyGeometry,InAnalogInputEvent)
    ...
    if InKeyName == "Gamepad_RightY" then
        ...
        -- DebugPrint("Tianyi@ ListScrollOffset: ", ScrollOffset)
