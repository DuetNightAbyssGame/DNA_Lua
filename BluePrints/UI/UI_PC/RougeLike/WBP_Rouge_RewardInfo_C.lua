...
local WBP_Rouge_RewardInfo_C = Class({"BluePrints.Common.TimerMgr", "BluePrints.UI.BP_EMUserWidget_C"})
...
function WBP_Rouge_RewardInfo_C:Construct()
	...
	--self.Text_ScoreTitle:SetText(GText("UI_Rougelike_RewardScore"))
