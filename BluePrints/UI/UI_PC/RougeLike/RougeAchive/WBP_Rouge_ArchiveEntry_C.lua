...
function WBP_Rouge_ArchiveEntry_C:InitView(ArchiveType, ArchiveData)
    ...
    self.Btn_Click.OnClicked:Add(self, function() self.ArchiveData.OnEntryClicked(self.Owner, self.ArchiveType) end)
    self.Btn_Click.OnHovered:Add(self, function() self.ArchiveData.OnEntryHovered(self.Owner, self.ArchiveType) end)
