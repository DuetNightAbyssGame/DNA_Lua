...
local WBP_Rouge_RewardItem_C = Class({"BluePrints.UI.BP_EMUserWidget_C","BluePrints.Common.TimerMgr"})
...
function WBP_Rouge_RewardItem_C:PlayAnim(Content)
    ...
    if (self.Index-1>=self.Parent.ScrollIndex) and Content.StartTime+0.05*(self.Index-self.Parent.ScrollIndex) + 0.1>currentTime and self.Parent.PlayInAnimation then
