...
--function CircleAroundPointer:Initialize(Initializer)
--end

--function CircleAroundPointer:PreConstruct(IsDesignTime)
--end
...
function CircleAroundPointer:TriggerPointer()
    ...
    -- local _, proxy = UE4.UWidgetAnimationPlayCallbackProxy.CreatePlayAnimationProxyObject(nil, self, self.Press)
    -- proxy.Finished:Add(self, function() self.IsPlayingTriggerAnim = false end)
    -- if self.State == "CanTrigger" and self.BeginTick then
