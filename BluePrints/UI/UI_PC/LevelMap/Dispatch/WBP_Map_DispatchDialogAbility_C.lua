...
--         local CurScrollOffset = self.List_Ability.EMScrollBox_1:GetScrollOffset()
--         local ScrollOffset = math.clamp(CurScrollOffset - a,0, self.List_Ability.EMScrollBox_1:GetScrollOffsetOfEnd())
--         self.List_Ability.EMScrollBox_1:SetScrollOffset(ScrollOffset)
--     end
