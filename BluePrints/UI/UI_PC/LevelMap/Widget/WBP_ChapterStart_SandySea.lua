...
---@type WBP_ChapterStart_SandySea_C
local M = Class({"BluePrints.UI.BP_UIState_C"})

function M:OnLoaded(...)
    self.Super.OnLoaded(self, ...)
    self.Text_Title:SetText(GText("ChapterIntro_SandrealmintheDream"))
    self:SetFontSize()
    self.Text_World:SetText(GText("ChapterIntroWd_SandrealmintheDream"))
