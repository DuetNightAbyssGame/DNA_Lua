...
---@type WBP_Map_InteractiveItem_C
...
function M:Init(SelectPoint,MainMap)
    ...
    local ClassName = SelectPoint:GetClass():GetName()
        local Text = ''
    if ClassName == 'WBP_Map_Point_C' then
    ...
    elseif ClassName == 'WBP_GuidePoint_MiniMap_C' then
    ...
    elseif ClassName == "WBP_Map_DispatchPointInfo_C" then
