...
---@type LevelMap_RegionInfo_Widget_PC_C
...
function M:Init(RegionId, Spacer)
    ...
    if not ConditionUtils.CheckCondition(Avatar,30) then
        -- self.Dimension:SetVisibility(ESlateVisibility.Collapsed)
        ...
        -- self.Dimension:SetVisibility(ESlateVisibility.SelfHitTestInvisible)
