...
function WBP_Experience_Item_C:SetMagnification(Magnification)
    -- 使用归一化函数计算缩放比例
    local normalizedScale = self:Normalize(
        Magnification,  -- 输入值
        0.64,           -- 输入最小值
        1.0,            -- 输入最大值
        self.MinScale or 0.64, -- 输出最小值 (缩放)
        1.0             -- 输出最大值
    )
    ...
    -- 使用归一化函数计算不透明度
    local normalizedOpacity = self:Normalize(
        Magnification,  -- 输入值
        0.64,           -- 输入最小值
        1.0,            -- 输入最大值
        self.MinOpacity or 0.4, -- 输出最小值 (不透明度)
        1.0             -- 输出最大值
    )
