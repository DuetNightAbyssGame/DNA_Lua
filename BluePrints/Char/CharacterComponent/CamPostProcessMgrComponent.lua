...
function CamPostProcessMgrComponent:AddBlendableMaterial(Material, Weight)
	-- asume that one Material only have One DynamicInstance at once
...
function CamPostProcessMgrComponent:CameraFade(Duration, FadeOut)
	...
	-- print('2222222222222222222222222222222222222222222222222222',Due)
	self:ChangeMaterialParamentFloat(FadeMat:get(), "TimePass", Due)
	if self:GetMaterialParamentFloat(FadeMat:get(), "TimePass") == 0 then
...
-- StartCameraFade在手机端失效，建议使用此新接口
