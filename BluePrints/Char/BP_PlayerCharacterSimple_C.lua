...
function BP_PlayerCharacterSimple_C:ReceiveTick(DeltaSeconds)
    -- self:CheckCanStandupInTick()
    -- BP_PlayerCharacterSimple_C.Super.ReceiveTick(self, DeltaSeconds)
    -- CallOverridden(self, DeltaSeconds)
    -- self:LatenTick(DeltaSeconds)
end

-- function BP_PlayerCharacterSimple_C:GetObjType()
...
-- function BP_PlayerCharacterSimple_C:GetCameraComponent()
...
--function BP_PlayerCharacterSimple_C:UseSkill(SkillId, IsTickUse)
--    if not self.Super.UseSkill(self, SkillId, IsTickUse) then
--        return false
--    end
--    return true
--end

-- function BP_PlayerCharacterSimple_C:GotRotationInput()
...
AssembleComponents(BP_PlayerCharacterSimple_C, {"CheckJumpStage"})
