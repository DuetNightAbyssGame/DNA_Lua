...
function Component:CountHealData(Character,Heal,Source,Target)
    ...
    if not  self.CharacterData then  self.CharacterData={} end
    if not  self.RobotData then self.RobotData={} end
...
-- function Component:CountDamagedData(Character,Damaged,Source,Target)
--     if(not self:IsInAutoTest()) then
--         return
--     end
--     local RootSource=  Source:GetRootSource()
...
--         self.Damaged= Damaged.TrueValue
--     else
--         self.Damaged=self.Damaged+Damaged.TrueValue
--     end
--     local CharacterType="Robot"
--     if Character:IsRobot() then
--       CharacterType="Player"
--     end
--     local DamagedData=CharacterType..Character.CurrentRoleId
--     if not Character:IsRobot() then
--         self.RobotData[ DamagedData]=self.RobotData[ DamagedData] or{}
--         self.RobotData[ DamagedData]["Damaged"]= self.Damaged
--     else
--         self.CharacterData[ DamagedData]=self.CharacterData[ DamagedData] or {}
--         self.CharacterData[ DamagedData]["Damaged"]= self.Damaged
--     end
--     self.Data["RobotData"]=self.RobotData
--     self.Data["CharacterData"]=self.CharacterData
--     local GameMode = GWorld.GameInstance:GetCurrentGameMode()
