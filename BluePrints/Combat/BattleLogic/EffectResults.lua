...
local UnpackEffectStruct = function(InEffectStruct)
...
local ToEffectStruct = function(self, InEffectStruct)
	self.Add = nil
...
local LocalResult = {
	...
	Add = function(self, Type, Value)
		...
		self.IsEmpty = false
		table.insert(self, {[Type]=Value})
	end,

	ToEffectStruct = ToEffectStruct,
	-- ToEffectStruct = function(self, EffectStruct)
	-- 	local Results = New(LocalResults)
	-- 	Results:Add(self)
	-- 	return ToEffectStruct(Results, EffectStruct)
	-- end,
}
