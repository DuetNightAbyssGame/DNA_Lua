...
--        if SourceEid and SourceEid ~= 0 then
...
--        UE4.UResourceLibrary.LoadClassAsync(self, RealEffectCreaturePath, {self, function(self, BPCLass)
...
--                if SocketName and SocketName ~= nil and self.Mesh:GetSocketBoneName(SocketName) ~= "None" then
...
--        Effect:PlaySe()
--    end
--    if Effect.InitialLifeSpan == 0 then
...
--        if EffectCreature.InitialLifeSpan == 0 then
...
--    end
--    local EffectCreatureData = DataMgr.EffectCreature[EffectCreatureId]
--    SocketName = (SocketName and (SocketName ~= "" and SocketName ~= "None")) and SocketName or EffectCreatureData.SocketName or "root"
--    if not self.EffectCreatures[EffectCreatureId] then
--        self.EffectCreatures[EffectCreatureId] = {}
--    end
--    local function LoadFinishCallBack(EffectCreature)
--        if EffectCreature.InitialLifeSpan == 0 and not IsNotEnterList then
--            table.insert(self.EffectCreatures[EffectCreatureId], EffectCreature)
--        end
--        if LuaCallBack then
...
--    self:AsyncCreateEffectCreature(EffectCreatureId, nil, true, nil, 
--    function(PetEffectCreature)
...
--        PetEffectCreature.LoadMeshCallBack = function()
...
--    end
--    if not HideTag then return end
--    if IsHide then
...
--    self:InitEffectCreatureComponent()
--    if not self.SkillFeatureEffectCreatureHideTags then  --SkillFeatureEffectCreatureHideTags
...
--    end
--
--    -- SkillFeature tags（只对 HideOnSkillFeature 生效）
