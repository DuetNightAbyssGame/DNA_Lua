...
--function BP_BattleEventComponentClient_C:Initialize(Initializer)
--end
...
-- function BP_BattleEventComponentClient_C:RefreshDelegates_Lua(DeleNames)
-- 	-- for _, EventName in ipairs(BattleEventName) do
-- 	-- 	if self[EventName] and self[EventName]:IsBound() then
-- 	-- 		self.T = self.T or {}
...
-- 		self.BattleEventBroadcast = MiscUtils.EmptyFunction
-- 	else
-- 		self.BattleEventBroadcast = BP_BattleEventComponentClient_C.BattleEventBroadcast
-- 	end
-- end

-- -- 这个只给Battle用，角色被动的在PassiveEffectComponent
-- function BP_BattleEventComponentClient_C:TriggerBattleEvent(EventName, Character, ...)
...
-- function BP_BattleEventComponentClient_C:BattleEventBroadcast(EventName, Character, ...)
-- 	-- Battle直接注册的
...
-- -- 广播给队友
-- function BP_BattleEventComponentClient_C:BattleEventBroadcastTeammate(EventName, Character, ...) 
...
-- function BP_BattleEventComponentClient_C:HasEvent()
-- 	return self.BattleEventDelegates
-- end

-- function BP_BattleEventComponentClient_C:GetEvent(EventName)
-- 	return self.BattleEventDelegates and self.BattleEventDelegates[EventName]
-- end


-- -- 触发被动
-- function BP_BattleEventComponentClient_C:TriggerPassiveEvent(EventName, Character, ...)
