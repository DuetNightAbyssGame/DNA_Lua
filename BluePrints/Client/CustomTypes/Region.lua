...
--  local QuestRegionBaseDataAttr = Class("QuestRegionBaseDataAttr", RegionBaseDataAttr)
-- 	QuestRegionBaseDataAttr.__Props__ = {
-- 		QuestChainId = prop.prop("Int","client"),
-- 	}
-- 	FormatProperties(QuestRegionBaseDataAttr)
--  local RarelyRegionBaseDataAttr = Class("RarelyRegionBaseDataAttr", RegionBaseDataAttr)
-- 	RarelyRegionBaseDataAttr.__Props__ = {
-- 		RarelyId = prop.prop("Int","client"),
-- 	}
-- 	FormatProperties(RarelyRegionBaseDataAttr)
--  local CommonRegionBaseDataAttr = Class("CommonRegionBaseDataAttr", RegionBaseDataAttr)

-- 	FormatProperties(CommonRegionBaseDataAttr)

--  local CommonDailyRegionBaseDataAttr = Class("CommonDailyRegionBaseDataAttr", RegionBaseDataAttr)

-- 	FormatProperties(CommonDailyRegionBaseDataAttr)
--  local CommonTriduumRegionBaseDataAttr = Class("CommonTriduumRegionBaseDataAttr", RegionBaseDataAttr)

-- 	FormatProperties(CommonTriduumRegionBaseDataAttr)
--  local CommonWeeklyRegionBaseDataAttr = Class("CommonWeeklyRegionBaseDataAttr", RegionBaseDataAttr)

-- 	FormatProperties(CommonWeeklyRegionBaseDataAttr)
...
local LastRegionData = Class("LastRegionData", CustomTypes.CustomAttr)
	...
	-- 检测区域ID合法性 服务器验证 Rotation记录的是XYZ，不是 pitch, yaw, roll
	function LastRegionData:UpdatePlayerInfo(Info)
		if not Info then return end
		if not self:SetRegionId(Info.RegionId) then return end
