...
function Component:CheckUseMonShareSkill(BattleGroupId, SkillId)
    if not BattleGroupId or BattleGroupId == 0 then
        return true
    end
    if not self.MonShareSkillCdBattleGroup[BattleGroupId] then
...
function Component:HandleUseMonShareSkill(BattleGroupId, SkillId)
    if not BattleGroupId or not self.MonShareSkillCdBattleGroup[BattleGroupId] or not self.MonShareSkillCdBattleGroup[BattleGroupId][SkillId] then
        return
    end
