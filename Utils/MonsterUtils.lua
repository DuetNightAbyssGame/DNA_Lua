...
function MonsterUtils.Tier(Id)
    if MonsterUtils.IsBoss(Id) then return 0 end
    if MonsterUtils.IsElite(Id) then return 1 end
    return 2
end
...
-- function MonsterUtils.GetDescription(MonsterId)
--     local GalleryRule = MonsterUtils.GetGalleryRuleInfo(MonsterId)
--     if not GalleryRule then return end
--     return GalleryRule.Description
-- end
