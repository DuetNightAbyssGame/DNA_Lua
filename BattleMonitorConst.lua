...
BattleMonitorConst.ATK_Char = 8000                         --角色攻击
BattleMonitorConst.DEF = 8000                              --角色防御
BattleMonitorConst.HP = 40000                              --角色血量
BattleMonitorConst.SP = 40000                              --角色护盾
BattleMonitorConst.ATK_Weapon = 8000                       --角色武器攻击
BattleMonitorConst.SkillIntensity = 8                      --角色技能强度
BattleMonitorConst.Strong = 8                              --角色昂扬
BattleMonitorConst.Enmity = 4                               --角色背水
BattleMonitorConst.CRI = 5                                  --暴击
BattleMonitorConst.CRD = 20                                  --爆伤
BattleMonitorConst.Mul_Shoot = 5                            --多重射击
