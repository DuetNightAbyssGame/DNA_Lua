---@class SetPlayerStatusNode : BaseQuestNode
...
function SetPlayerStatusNode:Execute()
    ...
    -- PlayerCharacter:AddSp(MiscUtils.Round(self:CalcModifyAttrPercentChangeValue(PlayerCharacter, "Sp", self.SPPercent)), EChangedSpReason.FromBP)
