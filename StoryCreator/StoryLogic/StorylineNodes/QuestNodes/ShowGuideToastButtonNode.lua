...
function ShowGuideToastButtonNode:ShowMessage(Context)
    ...
    if self.ShowEnable then
        ...
        self.UIStateAsyncActionBase = UE4.UUIStateAsyncActionBase.ShowGuideToastButton(GameInstance, self.MessageId, self.LastTime, self.DelayTime,
        self.HighLightUIPath, self.UICompName, self.UIShape, true, UICompSizeOffsetVector, UICompLocOffsetVector,
        self.MessageParentLoc, self.MessageLoc, MessageLocOffsetVector, self.IsForbidInAnim, self.IsForbidOutAnim)
