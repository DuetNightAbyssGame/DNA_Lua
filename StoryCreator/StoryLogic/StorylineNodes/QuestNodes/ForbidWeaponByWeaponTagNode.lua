...
-- 测试指令
-- gm teststlnode ForbidWeaponByWeaponTagNode {WeaponTags={"Melee","Ranged"},bForbid=true}
-- gm teststlnode ForbidWeaponByWeaponTagNode {WeaponTags={"Melee","Ranged"},bForbid=false}
...
function ForbidWeaponByWeaponTagNode:OnQuestlineSuccess()
    ...
    -- self.Context:SaveSuitUpdateData("UpdateSuitTable2Table", CommonConst.SuitType.PlayerCharacterSuit, CommonConst.PlayerCharacterSuit.DisableWeapon, self.RealWeaponTags, self.bForbid, self.ForbidTag, self.bHidewhenForbid)
end
