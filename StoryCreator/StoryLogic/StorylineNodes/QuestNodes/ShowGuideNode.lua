...
function ShowGuideNode:Touch(Context)
    ...
    self.UIStateAsyncActionBase = UE4.UUIStateAsyncActionBase.ShowGuide(GameInstance, self.MessageId, self.EnumSkillNameList, self.LastTime, self.bIsForceTouch, self.bIsTimeDilation,
    self.HighLightUIPath, self.UICompName, self.UIShape, true, UICompSizeOffsetVector, UICompLocOffsetVector,
    self.MessageParentLoc, self.MessageLoc, MessageLocOffsetVector, self.IsForbidInAnim, self.IsForbidOutAnim, self.ForbidSuccessAnim, self.IsNotForceRelease)
