...
function M:CheckCollectCompleted()
	...
	Avatar:DoRefreshTaskItemUIInfo("Modify", nil, { CollectedCount, self.NeedCount, self.Context.QuestChainId, self.QuestId, self })
...
function M:OnChooseTrack()
	...
	Avatar:DoRefreshTaskItemUIInfo("Modify", nil, { Count, self.NeedCount, self.Context.QuestChainId, self.QuestId, self })
end
