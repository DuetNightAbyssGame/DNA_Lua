...
function AtmosphereNpcHideNode:OnQuestlineSuccess()
    ...
    self.Context:SaveSuitUpdateData("UpdateSuitTable2Value",
    CommonConst.SuitType.PlayerCharacterSuit, CommonConst.PlayerCharacterSuit.NpcHideShowTag,
    self.AtmosphereTagList, self.IsHide)
end
