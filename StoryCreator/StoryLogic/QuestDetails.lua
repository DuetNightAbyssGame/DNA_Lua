---@class FQuestNodeQuestInfo
---@field public Type string
---@field public PropsData table<string, any>
local FQuestNodeQuestInfo = {}

---@param QuestNode table<string, any>
---@return FQuestNodeQuestInfo
function FQuestNodeQuestInfo:New(QuestNode)
	if QuestNode == nil then
		DebugPrint('Warning: FQuestNodeQuestInfo.New: QuestNode is Empty')
		return nil
	end

	local QuestNodeQuestInfo = setmetatable({}, {
		__index = FQuestNodeQuestInfo
	})
...
---@class FStoryNodeQuestInfo
---@field public Type string
---@field public PropsData table<string, any>
---@field public QuestNodeQuestInfos table<string, FQuestNodeQuestInfo>
...
function FStoryNodeQuestInfo:New(StoryNode)
	...
	local StoryNodeQuestInfo = setmetatable({}, {
		__index = FStoryNodeQuestInfo
	})
...
---@class FQuestDetails
---@field public QuestStoryNodeQuestInfos table<integer, FStoryNodeQuestInfo>
local FQuestDetails = {}

---@param Storyline Storyline
---@return FQuestDetails
function FQuestDetails:New(Storyline)
	local QuestDetails = setmetatable({}, {
		__index = FQuestDetails
	})
