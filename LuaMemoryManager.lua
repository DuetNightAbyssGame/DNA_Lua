...
function LuaMemoryManager:EnableLuaMemoryMonitor()
    ...
    local LuaMemoryMonitor = function ()
    ...
    self.Monitor = UE4.UKismetSystemLibrary.K2_SetTimerDelegate({GWorld.GameInstance, LuaMemoryMonitor}, GCTime, true)
end
